...
export const BlogCTA: React.FC = () => {
    ...
    return (
        <div className="my-10 p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-primary/20 via-surface to-accent/10 border border-primary/20 relative overflow-hidden group">
            {/* Background Effects */}
            <div className="absolute -top-24 -right-24 size-48 bg-primary/20 rounded-full blur-3xl group-hover:bg-primary/30 transition-colors" />
            <div className="absolute -bottom-24 -left-24 size-48 bg-accent/20 rounded-full blur-3xl group-hover:bg-accent/30 transition-colors" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <Link
                    to={!user || user.isGuest ? "/login" : "/dashboard"}
