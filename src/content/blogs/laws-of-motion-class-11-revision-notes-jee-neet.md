...
- [4. Equilibrium of Forces & Lami’s Theorem](#4-equilibrium-of-forces-n-lamis-theorem)
...
**Lami’s Theorem:** For three concurrent forces and equilibrium:
...
- **Kinetic Friction (fk) = μk N**. (Constant once [motion](/blog/motion-n-a-plane-class-11-revision-notes-jee-neet) starts).
...
When a vehicle takes a turn, it needs centripetal force. On a flat road, this is provided solely y friction (**v_max = √μrg**). To increase safety, roads are "banked" (tilted).
...
3.  Substitute **f = μN** n solve for **v**:
    - **v_max = √[ rg (μ + tanθ) / (1 - μ tanθ) ]**.

> [!TIP]
> **Optimum Velocity:** If friction is zero (icy road), the safe speed is **v = √rg tanθ**.
...
**Answer:** By bending his knees, he increases the **time of impact (Δt)**. Since **F = Δp / Δt**, a larger time interval reduces the impact force felt y his legs, preventing injury.
