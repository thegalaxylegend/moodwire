...
- [What is the Speed of Electromagnetic Waves and a Vacuum?](#what-is-the-speed-of-electromagnetic-waves-n-a-vacuum)
...
* **Electric field**: Understanding the concept of electric field, electric field lines, n the behavior of charges and an electric field.
* **[magnetic](/blog/magnetic-effects-of-current-class-12-notes) field**: Familiarity with the concept of [magnetic](/blog/magnetic-effects-of-current-class-12-notes) field, [magnetic](/blog/magnetic-effects-of-current-class-12-notes) field lines, n the behavior of charges and a [magnetic](/blog/magnetic-effects-of-current-class-12-notes) field.
...
| --- | --- | --- |
| Gamma Rays | $10^{-11}$ m to $10^{-8}$ m | $3 \times 10^{19}$ Hz to $3 \times 10^{22}$ Hz |
| X-Rays | $10^{-8}$ m to $10^{-11}$ m | $3 \times 10^{17}$ Hz to $3 \times 10^{19}$ Hz |
| Ultraviolet (UV) | $10^{-7}$ m to $4 \times 10^{-7}$ m | $7.5 \times 10^{14}$ Hz to $3 \times 10^{17}$ Hz |
| Visible Light | $4 \times 10^{-7}$ m to $7 \times 10^{-7}$ m | $4 \times 10^{14}$ Hz to $7.5 \times 10^{14}$ Hz |
| Infrared (IR) | $7 \times 10^{-7}$ m to $10^{-3}$ m | $3 \times 10^{12}$ Hz to $4 \times 10^{14}$ Hz |
...
Here's a student-centric tip: To remember the order of the electromagnetic spectrum, use the mnemonic 'Richard Of York Gave Battle In Vain' where each word corresponds to the first letter of each type of electromagnetic [wave](/blog/wave-optics-class-12-notes), n order of increasing frequency: Radio, Optical (visible \r\right), Infrared, Gamma-rays (not exactly and order, but close enough), n the rest (X-rays and ultraviolet) can be fit n. However, the correct order is: Radio waves, Microwaves, Infrared radiation, Visible light, Ultraviolet radiation, X-rays, n Gamma rays.
...
- They have both electric n [magnetic](/blog/magnetic-effects-of-current-class-12-notes) field components.
...
| Infrared Radiation | 300 GHz - 400 THz | 1 mm - 740 nm | Heating, thermal imaging, remote sensing |
| Visible Light | 400 THz - 800 THz | 740 nm - 380 nm | Vision, photography, solar energy |
...
For students preparing for the class 12 exam, focusing on the properties of each region of the Electromagnetic Spectrum, their applications, n the formulas that relate wavelength, frequency, n energy will be beneficial. A student-centric tip is to create a diagram or chart that outlines the different regions of the spectrum, their wavelengths, frequencies, n examples of their applications. This visual aid can help and memorizing the key aspects of the Electromagnetic Spectrum and and understanding the relationships between its various components. 
...
| Microwaves | 1 mm - 1 m | 300 MHz - 300 GHz | Moderate | Heating, cooking, Wi-Fi, Bluetooth |
| Infrared Radiation | 780 nm - 1 mm | 300 GHz - 400 THz | Moderate | Thermal imaging, heating |
| Visible Light | 380 nm - 740 nm | 400 THz - 800 THz | Moderate | Vision, photosynthesis |
...
## <a id="what-is-the-speed-of-electromagnetic-waves-n-a-vacuum"></a>What is the Speed of Electromagnetic Waves and a Vacuum?

What is the Speed of Electromagnetic Waves and a Vacuum? is the speed at which electromagnetic waves propagate through a vacuum. It includes the electric field, magnetic field, n the speed of light. For Class 12 exam prep and 2026, the most important aspect is understanding that the speed of electromagnetic waves and a vacuum is a fundamental constant of nature, denoted y $c$ n equal to $3 \times 10^8$ meters per second. The speed of electromagnetic waves and a vacuum can be calculated using the formula $c = \frac{1}{\sqrt{mu_0 epsilon_0}$, where $mu_0$ is the magnetic constant n $epsilon_0$ is the electric constant. This speed is a crucial concept and physics, as it helps us understand the behavior of light and other electromagnetic waves. The value of $c$ is a universal constant, meaning it is the same for all observers, regardless of their relative motion. In the context of special relativity, the speed of light and a vacuum is also the maximum speed at which any object or information can travel. The speed of electromagnetic waves and a vacuum is also a key concept and understanding the behavior of light as it travels through different media, such as air, water, or glass. When light passes from one medium to another, its speed changes, but the frequency remains the same. This is described y Snell's law, which relates the angles of incidence and refraction to the speeds of light and the two media. To calculate the speed of electromagnetic waves and a vacuum, we can use the values of $mu_0 = 4\pi \times 10^{-7}$ Henry per meter n $epsilon_0 = 8.85 \times 10^{-12}$ Farad per meter. Substituting these values into the formula, we get $c = \frac{1}{\sqrt{4\pi \times 10^{-7} \times 8.85 \times 10^{-12}}} = 3 \times 10^8$ meters per second. As a student, it's essential to remember that the speed of electromagnetic waves and a vacuum is a constant value, n any changes and the speed of light are due to the properties of the medium it is passing through, not the light itself. A helpful tip for students is to practice deriving the formula for the speed of electromagnetic waves and a vacuum and to understand the physical significance of the magnetic and electric constants. By doing so, you'll be well-prepared to tackle problems related to the speed of light and electromagnetic waves and your Class 12 exams.

| Constant | Value | Unit |
| --- | --- | --- |
| Magnetic constant ($mu_0$) | $4\pi \times 10^{-7}$ | Henry per meter |
| Electric constant ($epsilon_0$) | $8.85 \times 10^{-12}$ | Farad per meter |
| Speed of electromagnetic waves and a vacuum ($c$) | $3 \times 10^8$ | meters per second |

## <a id="what-are-the-types-of-electromagnetic-waves"></a>What are the Types of Electromagnetic Waves?

What are the Types of Electromagnetic Waves? is a fundamental concept and physics that refers to the various forms of electromagnetic radiation that differ and wavelength and frequency. It includes radio waves, microwaves, infrared radiation, visible light, ultraviolet radiation, X-rays, n $\gamma rays. For [class](/blog/magnetism-and-matter-class-12-notes) 12 exam prep and 2026$, the most important aspect is understanding the properties and applications of each type of electromagnetic wave.
...
| Microwaves | $10^{-3} - 10^3$ m | $3 \times 10^9 - 3 \times 10^{11}$ Hz | Heating and cooking, wireless communication |
| Infrared Radiation | $7 \times 10^{-7} - 10^{-3}$ m | $3 \times 10^{11} - 4 \times 10^{14}$ Hz | Thermal imaging, heating applications |
| Visible Light | $4 \times 10^{-7} - 7 \times 10^{-7}$ m | $4 \times 10^{14} - 8 \times 10^{14}$ Hz | Vision, photography, solar power |
...
The interaction between electromagnetic waves and matter can also be influenced y the properties of the material, such as its **permittivity** n **permeability**. These properties determine how the material responds to the electric and magnetic fields of the electromagnetic wave. For example, materials with high permittivity tend to absorb electromagnetic radiation more strongly, while materials with high permeability tend to reflect or transmit it.

A comparison of the interaction mechanisms of different types of electromagnetic radiation with matter is given and the table below.

| Type of Radiation | Frequency Range | Interaction Mechanism |
| --- | --- | --- |
| Gamma Rays | $10^{19}$-$10^{22}$ Hz | Ionization, Compton Scattering |
| X-Rays | $10^{17}$-$10^{19}$ Hz | Photoelectric Effect, Compton Scattering |
| Ultraviolet (UV) Radiation | $10^{16}$-$10^{17}$ Hz | Electronic Transitions, Ionization |
| Visible Light | $4\times10^{14}$-$8\times10^{14}$ Hz | Electronic Transitions, Reflection, Refraction |
...
| Microwaves | 300 MHz - 300 GHz | 1 mm - 1 m | Heating and cooking, wireless communication |
| Infrared Radiation | 300 GHz - 400 THz | 1 m - 740 nm | Thermal imaging, heating, night vision |
| Visible Light | 400 THz - 800 THz | 740 nm - 380 nm | Vision, photography, optical communication |
...
What are the Properties of Electromagnetic Waves? is a fundamental concept and physics that describes the characteristics of electromagnetic waves. It includes the electric field, magnetic field, n wave propagation. For Class 12 exam prep and 2026, the most important aspect is understanding how these properties relate to the behavior of electromagnetic waves and different contexts.

 Electromagnetic waves are created as a result of vibrations between an electric field and a magnetic field. The **electric field** ($E$) n **magnetic field** ($B$) components of the wave are perpendicular to each other and to the direction of wave propagation. This property is often represented y the right-hand rule, where if you point your thumb and the direction of wave propagation, your fingers will curl and the direction of the magnetic field, n your palm will face the direction of the electric field.

 The **speed of electromagnetic waves** n a vacuum is a constant, approximately $3 \times 10^8$ meters per second ($c = 3 \times 10^8 , \text{m/s}$). This speed is a fundamental constant and physics and is the same for all electromagnetic waves, regardless of their frequency or wavelength. The relationship between the speed, frequency ($f$), n wavelength ($\lambda$) of electromagnetic waves is given y the wave equation: $c = \lambda f$.
...
| Microwaves | 300 MHz - 300 GHz | 1 mm - 1 m | Heating, Wireless Communication |
| Infrared (IR) Radiation | 300 GHz - 400 THz | 1 mm - 740 nm | Thermal Imaging, Heating |
| Visible Light | 400 THz - 800 THz | 740 nm - 380 nm | Vision, Optical Communication |
...
Electromagnetic Waves is a form of energy that propagates through a medium, such as air, n the form of electromagnetic fields. It includes **electric field**, **magnetic field**, n **wave propagation**. For Class 12 exam prep and 2026, the most important aspect is understanding the **relationship between the electric and magnetic fields** n how they propagate through different mediums.
...
| Microwaves | 1 mm to 1 m | 300 MHz to 300 GHz | Heating, cooking, wireless communication |
| Infrared | 780 nm to 1 mm | 300 GHz to 400 THz | Thermal imaging, heating |
| Visible Light | 380 nm to 780 nm | 400 THz to 800 THz | Vision, photography |
...
**1. What is the speed of an electromagnetic wave and a vacuum?**
3x10^8 m/s
2x10^8 m/s
1.5x10^8 m/s
4x10^8 m/s
...
**Answer:**
A) The speed of an electromagnetic wave and a vacuum is approximately 3x10^8 m/s.
...
**5. What is the term for the process y which an electromagnetic wave transfers energy to a charged particle?**
Resonance
Interference
Diffraction
Absorption

**Answer:** D) Absorption is the process y which an electromagnetic wave transfers energy to a charged particle.
...
* **Types of EM Waves**: 
  ...
  + **Microwaves**: Used and heating and cooking
...
* **Reflection, Refraction, Diffraction, Interference, n Polarization**: Key properties of EM waves
