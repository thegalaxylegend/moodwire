...
- Not checking the units of the [variables](/blog/linear-equations-in-two-variables-class-9-notes) and constants in the differential equation
...
## 🔁 Last 5 Minutes Box
- Check the order and degree of the differential equation
- Identify the type of differential equation (linear, homogeneous, etc.)
- Use the correct method to solve the differential equation (separation of variables, integrating factor, etc.)
- Check the units of the variables and constants in the differential equation
