...
category: "Exam Notes"
date: "2026-04-20"
practice_link: "/practice/comparing-quantities-class-8-notes"
manualReview: false
---

## ⚡ Formula Bank
- Ratio of two quantities can be expressed as $\frac{a}{b}$, where $a$ and $b$ are the two quantities.
- To compare two ratios, we can use the concept of equivalent ratios, where $\frac{a}{b} = \frac{c}{d}$ if $ad = bc$.
- Percentage is a way to express a fraction as a part of 100, where $\frac{a}{b} = \frac{x}{100}$, and $x$ is the percentage.
...
- Not simplifying ratios to their simplest form, where $\frac{a}{b}$ can be simplified to $\frac{c}{d}$ if $a$ and $b$ have a common factor.
- Not using the concept of equivalent ratios to compare two ratios, where $\frac{a}{b} = \frac{c}{d}$ if $ad = bc$.
- Not converting fractions to percentages correctly, where $\frac{a}{b} = \frac{x}{100}$, and $x$ is the percentage.
...
- A boy scored 80 marks out of 100 in a test. What is his percentage score?
  - Step 1: Calculate the percentage score, where $\frac{80}{100} = \frac{x}{100}$, and $x$ is the percentage.
...
- The concept of equivalent ratios is often misunderstood by students, where $\frac{a}{b} = \frac{c}{d}$ if $ad = bc$.
- Many students fail to simplify ratios to their simplest form, where $\frac{a}{b}$ can be simplified to $\frac{c}{d}$ if $a$ and $b$ have a common factor.
- Students often struggle to convert fractions to percentages correctly, where $\frac{a}{b} = \frac{x}{100}$, and $x$ is the percentage.
