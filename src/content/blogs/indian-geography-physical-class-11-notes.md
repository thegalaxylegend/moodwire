...
## Quick Recall Box
The key concepts in Physical Geography can be quickly revised using the following points:
| Concept | Description |
| --- | --- |
| Lithosphere | The outermost solid layer of the Earth |
| Atmosphere | The layer of gases surrounding the Earth |
| Hydrosphere | The layer of water bodies on the Earth |
| Biosphere | The layer of living organisms on the Earth |

These concepts are essential for understanding the Earth's systems and processes. As I always say, "Understanding the basics is key to mastering Physical Geography."
...
| C | Brahmaputra |
| D | Godavari |
**Answer:** B) Ganga. The Ganga is the longest river in India, stretching over 2,500 kilometers from its source in the Himalayas to its delta in the Bay of Bengal. It flows through several states, including Uttarakhand, Uttar Pradesh, and West Bengal.
...
## What are the Core Concepts in Physical Geography?
