---
heroImage: "/blog-images/matter-in-our-surroundings-class-9-notes.webp"
...
- [🧠 The One Thing Most Students Get Wrong](#-the-one-thing-most-students-get-wrong)
  - [The One Thing Most Students Get Wrong](#the-one-thing-most-students-get-wrong)
  - [Key Formulas and Relations](#key-formulas-and-relations)
  - [Critical Concepts and Definitions](#critical-concepts-and-definitions)
  - [Common Mistakes to Avoid](#common-mistakes-to-avoid)
  - [Mastering the Topic](#mastering-the-topic)
  - [Real-Exam Questions You Might See](#realexam-questions-you-might-see)
...
- **Latent Heat of Vaporization Formula:** Q = mL — Q is heat transferred, m is mass, L is latent heat of vaporization
Examiner's Trap: Make sure to distinguish between latent heat of fusion and vaporization.
...
- **Root Mean Square Speed Formula:** v_rms = √(3RT/M) — v_rms is root-mean-square speed, R is gas constant, T is temperature, M is molar mass
Examiner's Trap: Be aware of the assumptions of the kinetic theory of gases.
...
- **Vapour Pressure Formula:** P = (n/V)RT — P is vapour pressure, n is a number of moles, V is volume, R is gas constant, T is temperature
Examiner's Trap: Understand the limitations of the ideal gas law.
...
| F = ρVg | calculating buoyant [force](/blog/force-and-laws-of-motion-class-9-notes) |
...
- **Mistake 1 — Confusing States of [Matter](/blog/is-matter-around-us-pure-class-9-notes):**
 

- 🔴 **What students write:** Ice, water, and water vapor are three different substances.

- ✅ **What examiners expect:** Ice, water, and water vapor are three states of [matter](/blog/is-matter-around-us-pure-class-9-notes) of H₂O.

- 💸 **Marks lost:** 2 marks
 

- 🔧 **The fix (30-second trick):** Remember, states of [matter](/blog/is-matter-around-us-pure-class-9-notes) are physical changes, not chemical changes.
...
**Q1 (2019 CBSE):** A sample of water is heated from 20°C to 50°C. What is the change in temperature in °F?
 ...
 Step 1: Recall the conversion formula: ΔT(°F) = ΔT(°C) × 9/5
 Step 2: Calculate ΔT(°C) = 50°C - 20°C = 30°C
 Step 3: Convert ΔT to °F: ΔT(°F) = 30 × 9/5 = 54°F
 **Final Answer:** 54 °F
...
**Q2 (2020 CBSE):** A gas is filled in a container at 25°C. If the temperature is increased to 35°C, what is the final temperature in Kelvin?
 ...
 - 🧮 **Solution (Step-by-step):**
 Step 1: Recall the conversion formula: T(K) = T(°C) + 273.15
 Step 2: Calculate initial T(K) = 25 + 273.15 = 298.15 K
 Step 3: Calculate final T(K) = 35 + 273.15 = 308.15 K
 **Final Answer:** 308.15 K
...
**Q3 (2018 CBSE):** What is the boiling point of water in Kelvin?
 ...
 - 🧮 **Solution (Step-by-step):**
 Step 1: Recall the boiling point of water: 100°C
 Step 2: Convert to Kelvin: T(K) = 100 + 273.15 = 373.15 K
...
What is the state of [matter](/blog/is-matter-around-us-pure-class-9-notes) that has particles with the most freedom of movement?
...
### <a id="key-formulas-and-relations"></a>Key Formulas and Relations

- **Kinetic Theory of Matter:** Matter is composed of tiny particles (atoms or molecules) that are in continuous [motion](/blog/force-and-laws-of-motion-class-9-notes).

- **States of [Matter](/blog/is-matter-around-us-pure-class-9-notes) and Particle Movement:**
...
### <a id="critical-concepts-and-definitions"></a>Critical Concepts and Definitions
...
### <a id="mastering-the-topic"></a>Mastering the Topic

- **Revision Tips:**
 

- Focus on visualizing particle arrangements and movements in different states of [matter](/blog/is-matter-around-us-pure-class-9-notes).
...
### <a id="realexam-questions-you-might-see"></a>Real-Exam Questions You Might See
