...
- F₂ generation = offspring of F₁ generation
...
- Map distance = (recombination frequency) × 100
- Mutation rate = (number of mutants)/(total number of offspring)
- Genetic drift = random change ∈ allele frequencies
- Gene flow = movement of genes from one population to another
- Natural selection = survival and [reproduction](/blog/human-reproduction-class-12-notes) of individuals with favorable traits
...
## ✏️ 3 Solved PYQs
- **Question 1:** What is the genetic ratio of a dihybrid cross?
  Step 1: Identify the alleles of the two genes
  Step 2: Determine the possible genotypes and phenotypes of the offspring
  Step 3: Calculate the genetic ratio using the Punnett square
  answer: 9:3:3:1
- **Question 2:** What is the mechanism of sex determination ∈ humans?
  Step 1: Identify the sex chromosomes ∈ humans
  Step 2: Determine the sex of the offspring based on the sex chromosomes
  Step 3: Expla∈ the role of the SRY gene ∈ sex determination
  Answer: Sex determination ∈ humans is based on the presence of the Y chromosome
- **Question 3:** What is the difference between mitosis and meiosis?
  ...
  Answer: Mitosis results ∈ two daughter cells with the same number of chromosomes, while meiosis results ∈ four daughter cells with half the number of chromosomes
...
> 🎬 **[Watch video explanations on YouTube →](https://www.youtube.com/results?search_query=Reproduction%20In%20Organisms%20Class%2012%20Exam%20Prep%20Revision%20%E2%80%94%20Grandmaster%20Guide%20JEE%20NEET%20revision)**
