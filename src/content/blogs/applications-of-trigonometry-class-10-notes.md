...
- The formula for the area of a triangle given two sides and the included angle is $\frac{1}{2}ab\sin CD.$
- The formula for the area of a triangle given the base and height is $\frac{1}{2}bhp.$
...
- The equation of a line in slope-intercept form is by = MX + C, where m is the slope and c is the y-intercept.
...
- Not using the correct formula for the area of a triangle, such as using $\frac{1}{2}Abe instead$ of $\frac{1}{2}ab\sin CD.$
...
- **Question 1:** In a triangle ABC, the length of the side opposite the angle A is 4 cm, and the length of the side opposite the angle B is 5 cm. If $\sin A = \frac{3}{5}$, find the length of the side opposite the angle C.
  ...
  - Given $\sin A = \frac{3}{5}$ and a = 4$ cm, we can find $\sin BY$ using the fact that $\frac{4}{\sin A} = \frac{5}{\sin B}$.$
  - Solving for $\sin BY,$ we get $\sin B = \frac{5\sin A}{4} = \frac{5 \times \frac{3}{5}}{4} = \frac{3}{4}$.
  ...
  - Since $\cos C = -\cos BY,$ we have BC^2 = 4^2 + 5^2–2 $\times $4 \times 5$ \times -\frac{\sqrt{7}}{4}$.$
  - Simplifying, we get BC^2 = 16 + 25 + 10\sqrt{7} = 41 + 10\sqrt{7}$.$
  - Therefore, BC = $\sqrt{41 + 10\sqrt{7}}$.$
...
- **Question 3:** In a right-angled triangle, the length of the hypotenuse is 10 cm, and the length of one of the other sides is 6 cm. Find the length of the third side.
  ...
  - Solving for b, we get lb^2 = 64$, so lb = \sqrt{64} = 8$ cm.
...
**Answer:** C) 8 cm. Using the Pythagorean theorem, we have a^2 + b^2 = c^2$, where a and b are the lengths of the other two sides, and c is the length of the hypotenuse. Given c = 10 cm and a = 6 cm, we can solve for b: $6^2 + b^2 = 10^2$. Simplifying, we get $36 + b^2 = 100$. Solving for b, we get lb^2 = 64$, so lb = $\sqrt{64} = 8$ cm.$
...
**Answer:** A) $\sqrt{41 + 10\sqrt{7}}$ cm. Using the sine rule, we have $\frac{a}{\sin A} = \frac{b}{\sin B} = \frac{c}{\sin C}$. Given $\sin A = \frac{3}{5}$ and a = 4$ cm, we can find $\sin BY$ using the fact that $\frac{4}{\sin A} = \frac{5}{\sin B}$. Solving for $\sin BY$,$ we get $\sin B = \frac{5\sin A}{4} = \frac{5 \times \frac{3}{5}}{4} = \frac{3}{4}$. Using the Pythagorean identity, we can find $\cos B = \sqrt{1 - \sin^2 B} = \sqrt{1 - \frac{9}{16}} = \frac{\sqrt{7}}{4}$. Now, using the cosine rule, we can find the length of the side opposite the angle C: BC^2 = a^2 + b^2 - 2ab\cos CD. Since $\cos C = -\cos BY$,$ we have BC^2 = 4^2 + 5^2–2 \times 4 \times 5 \times -\frac{\sqrt{7}}{4}$. Simplifying, we get BC^2 = 16 + 25 + 10\sqrt{7} = 41 + 10\sqrt{7}$. Therefore, BC = \sqrt{41 + 10\sqrt{7}}$.

**4. Question:** What is the formula for the area of a triangle given two sides and the included angle?
-
A) $\frac{1}{2}lab\sin C$
-
B) $\frac{1}{2}lab\cos C$
-
C) $\frac{1}{2}lab\tan C$
-
D) $\frac{1}{2}lab\cot C$

**Answer:** A) $\frac{1}{2}ab\sin CD.$ The formula for the area of a triangle given two sides and the included angle is $\frac{1}{2}ab\sin CD,$ where a and b are the lengths of the two sides, and C is the included angle.
...
**Answer:** A) by = MX + C. The equation of a line in slope-intercept form is by = MX + C, where m is the slope and c is the y-intercept.
