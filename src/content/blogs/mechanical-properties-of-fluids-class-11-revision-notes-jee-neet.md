...
> - **Surface Tension:** S = F/L. Excess pressure in drop = 2S/R; Bubble = 4S/R.
...
**Answer:** **Surface Tension.** A sphere is the shape with the minimum surface area for a given volume. Since surface tension seeks to minimize potential energy by reducing surface area, raindrops naturally adopt a spherical shape.
