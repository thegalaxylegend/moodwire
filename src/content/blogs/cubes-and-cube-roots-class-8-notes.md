...
## ⚡ Formula Bank
- The cube of a number $n$ is denoted by $n^3$ and is calculated as $n \times n \times n$.
- The cube root of a number $n$ is denoted by $\sqrt[3]{n}$ and is a value that, when multiplied by itself twice, gives the original number $n$.
...
## ✏️ 3 Solved PYQs
- **Question 1:** Find the value of $\sqrt[3]{125}$.
  - Step 1: Recall the formula for the cube root of a perfect cube, $\sqrt[3]{a^3} = a$
...
- The most common mistake students make when working with cubes and cube roots is not simplifying expressions before finding the cube root.
...
- C) 4
- D) 5
**Answer: C) 4, because $\sqrt[3]{64} = \sqrt[3]{4^3} = 4$**
...
**4. What is the value of $\sqrt[3]{216}$?**
- A) 4
- B) 5
- C) 6
- D) 7
**Answer: C) 6, because $\sqrt[3]{216} = \sqrt[3]{6^3} = 6$**
