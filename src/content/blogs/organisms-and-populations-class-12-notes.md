...
- **Mistake 1:** Incorrectly identifying the characteristics of a population, such as density, natality, and mortality, leading to confusion in understanding population dynamics.
 ...
 - *Fix:* Study the different types of species interactions, including $\times$-axis plots of predator-prey cycles, and practice analyzing their effects on ecosystem function.

 - **Mistake 4:** Incorrectly applying the concept of carrying capacity ($K$) to population growth models, leading to errors in calculating growth rates and equilibrium populations.
...
- **Q1:** What is the main difference between an r-strategist and a K-strategist in the context of population ecology?

 - **Trap:** Students often get confused between the two strategies and their characteristics.
...
| Selection Type | Characteristics | Examples |
| --- | --- | --- |
...
- A) A. Availability of food
- B) B. Availability of water
- C) C. Climate and geography
- D) D. All of the above

**Answer:** D) Population density is determined by a combination of factors including availability of food, water, climate, and geography.

---

**2. Which of the following is an example of a symbiotic relationship?**

- A) A. Predator-prey relationship
- B) B. Competition for resources
- C) C. Clownfish and sea anemone
- D) D. Parasitism

**Answer:** C) The relationship between clownfish and sea anemone is an example of mutualism, a type of symbiotic relationship where both species benefit.

---

**3. What is the term for the movement of individuals into a population from other areas?**
...
**Answer:** A) Immigration refers to the movement of individuals into a population from other areas, which can affect population density and gene flow.

---

**4. Which of the following is a characteristic of a K-selected species?**

- A) A. High reproductive rate
- B) B. Small body size
- C) C. Long gestation period
- D) D. Simple body structure

**Answer:** C) K-selected species are characterized by a low reproductive rate, large body size, and a long gestation period, which allows them to invest energy in fewer offspring.
...
- A) A. Ecology
- B) B. Biogeography
- C) C. Population biology
- D) D. Community ecology
