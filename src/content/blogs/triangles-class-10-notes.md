...
- **The Core Concept:** Triangles, specifically the concept of similarity and the relationship between their sides and angles. Understanding this deeply is what separates top scorers from the rest.
 ...
 - **Mistake to Avoid:** Assuming that all problems involving triangles require direct application of the Pythagorean theorem or basic trigonometry. Top scorers are adept at recognizing when a problem can be simplified through geometric reasoning and similarity.
