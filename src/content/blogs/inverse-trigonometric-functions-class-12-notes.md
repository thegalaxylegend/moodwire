...
- The range of $\tan^{-1}$ is $\left( -\frac{\pi}{2}, \frac{\pi}{2} \r\r\right)$.
-   $\\\\\sin^{-1}x =\frac{\pi}{2}$ - $\\\cos^{-1}x.$ 
-   $\\\cos^{-1}x =\frac{\pi}{2}$ - $\\\\\sin^{-1}x.$ 
- $\tan^{-1}x = \\\\\sin^{-1}\left( \frac{x}{\sqrt{1 + x^2}} \r\r\right)$.
-    \\\\\sin^{-1}x + \\\cos^{-1}x = $\frac{\pi}${2}. 
- $\tan^{-1}x + \tan^{-1}y = \tan^{-1}\left( \frac{x + y}{1 - XY} \r\r\right)$, OXY < 1$.$
- $\tan^{-1}x - \tan^{-1}y = \tan^{-1}\left( \frac{x - y}{1 + XY} \r\r\right)$, OXY > -1$.$
...
## ✏️ 3 Solved PYQs
- **Question 1:** Find the value of $\\\\\sin^{-1}\left( \\\sin\left( \frac{3\pi}{4} \r\r\right) \r\r\right)$.
  -     \\\\\sin^{-1}\left( \\\sin\left( $\frac{3\pi}${4} \r\r\right) \r\r\right) = \\\\\sin^{-1}\left( \\\sin\left( \pi - $\frac{\pi}${4} \r\r\right) \r\r\right). 
  -     -1}\left( \\\sin\left( $\frac{\pi}${4} \r\r\right) \r\r\right), since \\\sin(\pi - \theta) = \\\sin\theta. 
  -   RAC{\pi}{4}, since $\\\\\sin^{-1}\left( \\\sin\theta \r\r\right) = \theta$, \theta$\in \left[ -$\frac{\pi}${2}, $\frac{\pi}${2} \right]. 
- **Question 2:** Find the value of $\\\cos^{-1}\left( \\\cos\left( \frac{5\pi}{4} \r\r\right) \r\r\right)$.
  -     \\\cos^{-1}\left( \\\cos\left( $\frac{5\pi}${4} \r\r\right) \r\r\right) = \\\cos^{-1}\left( \\\cos\left( \pi + $\frac{\pi}${4} \r\r\right) \r\r\right). 
  -     -1}\left( -\\\cos\left( $\frac{\pi}${4} \r\r\right) \r\r\right), since \\\cos(\pi + \theta) = -\\\cos\theta. 
  -     -1}\left( \\\cos\left( \pi - $\frac{\pi}${4} \r\r\right) \r\r\right), since \\\cos(\pi - \theta) = -\\\cos\theta. 
  -     $\frac{\pi}${4}, since \\\cos^{-1}\left( \\\cos\theta\r\r\right) = \theta, \theta\in \left[ 0, \pi \right]. 
  -     3\pi}{4}. 
- **Question 3:** Find the value of $\tan^{-1}\left( \tan\left( \frac{3\pi}{4} \r\r\right) \r\r\right)$.
  -     \tan^{-1}\left( \tan\left( $\frac{3\pi}${4} \r\r\right) \r\r\right) = \tan^{-1}\left( \tan\left( \pi - $\frac{\pi}${4} \r\r\right) \r\r\right). 
  -     -1}\left( -\tan\left( $\frac{\pi}${4} \r\r\right) \r\r\right), since \tan(\pi - \theta) = -\tan\theta. 
  -   franc{\pi}{4}, since $\tan^{-1}\left( \tan\theta \r\r\right) = \theta$, \theta$\in \left( -$\frac{\pi}${2}, $\frac{\pi}${2} \r\r\right). 
...
- For example, $\\\\\sin^{-1}\left( \\\sin\left( \frac{3\pi}{4} \r\r\right) \r\r\right) = \\\\\sin^{-1}\left( \\\sin\left( \pi - \frac{\pi}{4} \r\r\right) \r\r\right)$.
- $= \\\\\sin^{-1}\left( \\\sin\left( \frac{\pi}{4} \r\r\right) \r\r\right)$, since $\\\sin(\pi - \theta) = \\\sin\theta.$
- $= \frac{\pi}{4}$, since $\\\\\sin^{-1}\left( \\\sin\theta \r\r\right) = \theta$, $\theta \in \left[ -\frac{\pi}{2}, \frac{\pi}{2} \right]$.
...
- And $\tan^{-1}x = \\\\\sin^{-1}\left( \frac{x}{\sqrt{1 + x^2}} \r\r\right)$.
...
## 📝 Practice MCQs
**1. Question:** Find the value of $\\\\\sin^{-1}\left( \\\sin\left( \frac{2\pi}{3} \r\r\right) \r\r\right)$.
-
A) \frac{\pi}{3}
-
B) \frac{2\pi}{3}
...
**Answer:** A) $\frac{\pi}{3}$, since $\\\\\sin^{-1}\left( \\\sin\theta \r\r\right) = \theta$, $\theta \in \left[ -\frac{\pi}{2}, \frac{\pi}{2} \right]$.

**2. Question:** Find the value of $\\\cos^{-1}\left( \\\cos\left( \frac{3\pi}{4} \r\r\right) \r\r\right)$.
-
A) \frac{\pi}{4}
-
B) \frac{3\pi}{4}
...
**Answer:** B) $\frac{3\pi}{4}$, since $\\\cos^{-1}\left( \\\cos\theta \r\r\right) = \theta$, $\theta \in \left[ 0, \pi \right]$.

**3. Question:** Find the value of $\tan^{-1}\left( \tan\left( \frac{\pi}{4} \r\r\right) \r\r\right)$.
-
A) -\frac{\pi}{4}
-
B) \frac{\pi}{4}
...
**Answer:** B) $\frac{\pi}{4}$, since $\tan^{-1}\left( \tan\theta \r\r\right) = \theta$, $\theta \in \left( -\frac{\pi}{2}, \frac{\pi}{2} \r\r\right)$.

**4. Question:** Find the value of $\\\\\sin^{-1}\left( \\\sin\left( \frac{5\pi}{4} \r\r\right) \r\r\right)$.
-
A) -\frac{\pi}{4}
-
B) \frac{\pi}{4}
...
**Answer:** A) $-\frac{\pi}{4}$, since $\\\\\sin^{-1}\left( \\\sin\theta \r\r\right) = \theta$, $\theta \in \left[ -\frac{\pi}{2}, \frac{\pi}{2} \right]$.

**5. Question:** Find the value of $\\\cos^{-1}\left( \\\cos\left( \frac{7\pi}{4} \r\r\right) \r\r\right)$.
-
A) \frac{\pi}{4}
-
B) \frac{3\pi}{4}
...
**Answer:** C) $\frac{\pi}{4}$, since $\\\cos^{-1}\left( \\\cos\theta \r\r\right) = \theta$, $\theta \in \left[ 0, \pi \right]$.
