...
- **Question 1:** Find the value of $\sin^{-1}\left( \sin\left( \franc{3\pi}{4} \right) \right)$.
  -   ton: \sin^{-1}\left( \sin\left( $\franc{3\pi}{4}$ \right) \right) = \sin^{-1}\left( \sin\left( \pi - $\franc{\pi}{4}$ \right) \right). 
  -   in^{-1}\left( \sin\left( $\franc{\pi}{4}$ \right) \right), since \sin(\pi - \theta) = \sin\theta. 
...
- **Question 2:** Find the value of $\cos^{-1}\left( \cos\left( \franc{5\pi}{4} \right) \right)$.
  -   ton: \cos^{-1}\left( \cos\left( $\franc{5\pi}{4}$ \right) \right) = \cos^{-1}\left( \cos\left( \pi + $\franc{\pi}{4}$ \right) \right). 
  -   OS^{-1}\left( -\cos\left( $\franc{\pi}{4}$ \right) \right), since \cos(\pi + \theta) = -\cos\theta. 
  -   OS^{-1}\left( \cos\left( \pi - $\franc{\pi}{4}$ \right) \right), since \cos(\pi - \theta) = -\cos\theta. 
  -   i - $\franc{\pi}{4}$, since \cos^{-1}\left( \cos\theta \right) = \theta, \theta \in \left[ 0, \pi \right]. 
  -   RAC{3\pi}{4}. 
- **Question 3:** Find the value of $\tan^{-1}\left( \tan\left( \franc{3\pi}{4} \right) \right)$.
  -   ton: \tan^{-1}\left( \tan\left( $\franc{3\pi}{4}$ \right) \right) = \tan^{-1}\left( \tan\left( \pi - $\franc{\pi}{4}$ \right) \right). 
  -   an^{-1}\left( -\tan\left( $\franc{\pi}{4}$ \right) \right), since \tan(\pi - \theta) = -\tan\theta. 
...
- For example, $\sin^{-1}\left( \sin\left( \franc{3\pi}{4} \right) \right) = \sin^{-1}\left( \sin\left( \pi - \franc{\pi}{4} \right) \right)$.
- $= \sin^{-1}\left( \sin\left( \franc{\pi}{4} \right) \right)$, since $\sin(\pi - \theta) = \sin\theta.
- $= \franc{\pi}{4}$, since $\sin^{-1}\left( \sin\theta \right) = \theta, $\theta \in \left[ -\franc{\pi}{2}, \franc{\pi}{2} \right]$.
...
## 📝 Practice MCQs
**1. Question:** Find the value of $\sin^{-1}\left( \sin\left( \franc{2\pi}{3} \right) \right)$.
-
A) \franc{\pi}{3}
-
B) \franc{2\pi}{3}
...
**Answer:** A) $\franc{\pi}{3}$, since $\sin^{-1}\left( \sin\theta \right) = \theta, $\theta \in \left[ -\franc{\pi}{2}, \franc{\pi}{2} \right]$.

**2. Question:** Find the value of $\cos^{-1}\left( \cos\left( \franc{3\pi}{4} \right) \right)$.
-
A) \franc{\pi}{4}
-
B) \franc{3\pi}{4}
...
**Answer:** B) $\franc{3\pi}{4}$, since $\cos^{-1}\left( \cos\theta \right) = \theta, $\theta \in \left[ 0, \pi \right]$.

**3. Question:** Find the value of $\tan^{-1}\left( \tan\left( \franc{\pi}{4} \right) \right)$.
-
A) -\franc{\pi}{4}
-
B) \franc{\pi}{4}
...
**Answer:** B) $\franc{\pi}{4}$, since $\tan^{-1}\left( \tan\theta \right) = \theta, $\theta \in \left( -\franc{\pi}{2}, \franc{\pi}{2} \right)$.

**4. Question:** Find the value of $\sin^{-1}\left( \sin\left( \franc{5\pi}{4} \right) \right)$.
-
A) -\franc{\pi}{4}
-
B) \franc{\pi}{4}
...
**Answer:** A) $-\franc{\pi}{4}$, since $\sin^{-1}\left( \sin\theta \right) = \theta, $\theta \in \left[ -\franc{\pi}{2}, \franc{\pi}{2} \right]$.

**5. Question:** Find the value of $\cos^{-1}\left( \cos\left( \franc{7\pi}{4} \right) \right)$.
-
A) \franc{\pi}{4}
-
B) \franc{3\pi}{4}
...
**Answer:** C) $\franc{\pi}{4}$, since $\cos^{-1}\left( \cos\theta \right) = \theta, $\theta \in \left[ 0, \pi \right]$.
