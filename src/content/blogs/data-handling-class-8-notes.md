...
* **Misinterpreting Mode**: Students often mistakenly calculate the mode as the value with the highest frequency, but they forget to check if there are multiple modes in the dataset. 
