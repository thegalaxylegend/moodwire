...
- **Mistake 1:** Forgetting to apply the chain rule in composite functions, which leads to incorrect calculation of derivatives. 
 ...
 - **Mistake 3:** Failing to consider the second derivative when determining the nature of stationary points (local maxima or minima). 

 - *Costs:* 5-7 marks per question

 - *Fix:* After finding $f'(x) = 0$, calculate $f''(x)$ to confirm if it's a maximum ($f''(x) < 0$) or minimum ($f''(x) > 0$).

 - **Mistake 4:** Not checking the endpoints when optimizing a function over a closed interval, leading to incorrect answers. 

 - *Costs:* 4-6 marks per question

 - *Fix:* Evaluate the function at both the critical points and the endpoints of the interval, and compare the values to find the absolute maximum or minimum.

 - **Mistake 5:** Incorrectly applying the first or second derivative tests for absolute extrema by neglecting to evaluate the function at the endpoints of the given interval. 
...
- **Q1:** Find the maximum value of $x^2y$ given that $x + y = 10$.
 ...
 - **Trap:** Students often get confused between the product rule and the chain rule for differentiation.

 - **Solution:** 

 To find the maximum value of $x^2y$, we first express $y$ in terms of $x$ from the constraint $x + y = 10$, which gives us $y = 10 - x$.

 Then, we substitute $y$ in the expression $x^2y$ to get $x^2(10 - x)$.

 Now, let $f(x) = x^2(10 - x) = 10x^2 - x^3$.
 ...
 - **Answer:** Velocity = 11 m/s, Acceleration = 4 m/s$^2$

 - **Q3:** Determine the equation of the tangent line to the curve $y = x^3 - 2x^2 + x + 1$ at $x = 1$.

 - **Trap:** Forgetting to evaluate the derivative at the given point to find the slope.
...
- **The Core Concept:** The core concept that separates 85% scorers from 95% scorers in the Application of Derivatives is the **optimization of functions using derivatives**. This involves finding the maximum or minimum value of a function, which is crucial in various fields such as physics, engineering, and economics.
 ...
 - **What 85% scorers do:** 85% scorers typically focus on finding the critical points of a function by taking its derivative and setting it equal to zero: $f'(x) = 0$. They then proceed to solve for $x$ and determine the nature of these critical points using the first or second derivative test. However, they often struggle with applying these concepts to real-world problems and may not consider the **domain of the function**, **boundary points**, or **multiple optima**.
...
abla g(x)
 ...
 - Key differences between 85% and 95% scorers:

 - Consideration of domain and boundary points

 - Ability to handle constrained optimization problems

 - Use of Lagrange multipliers and other advanced techniques

 - Ability to analyze the behavior of the function near its critical points

 - Consideration of physical or practical constraints

| Concept | 85% Scorers | 95% Scorers |
| --- | --- | --- |
| Optimization of functions | Focus on finding critical points | Consider domain, boundary points, and constrained optimization |
...
| Function | Derivative | Second Derivative | Roots of Derivative | Nature of Roots |
| --- | --- | --- | --- | --- |
...
- A) Finding maxima/minima
- B) Finding inflection points
- C) Solving differential equations
- D) Graphing functions

**Answer:** A) Derivatives are used to find the critical points of a function, which can be maxima or minima.

---

**2. A function f(x) has a derivative f'(x) = 2x. What is the equation of the tangent line at x = 2?**
...
**Answer:** B) First, find f(2) = 2^2 = 4. The slope at x = 2 is f'(2) = 2*2 = 4. Using point-slope form, y - 4 = 4(x - 2), which simplifies to y = 4x - 4.

---

**3. Which of the following is NOT an application of derivatives?**
...
**Answer:** D) Integration by parts is a technique of integration, not an application of derivatives.

---

**4. A company's profit function is P(x) = 100x - x^2, where x is the number of units sold. How many units should be sold to maximize profit?**
...
**Answer:** B) To maximize profit, take the derivative of P(x) and set it equal to zero. P'(x) = 100 - 2x = 0. Solving for x, x = 50.

---

**5. What is the name of the theorem that states if a function f is continuous on [a, b] and differentiable on (a, b), then there exists c in (a, b) such that f'(c) = (f(b) - f(a))/(b - a)?**
