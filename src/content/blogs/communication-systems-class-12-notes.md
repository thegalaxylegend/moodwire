...
| Not accounting for $\Delta  when calculating channel capacity using  = B \log_2(1 + \{S}{N})$ | 2 marks | Always consider the bandwidth  in Hz and ensure $\{S}{N}$ is correctly calculated |
