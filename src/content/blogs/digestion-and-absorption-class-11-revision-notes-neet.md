...
- [Introduction to Digestion and Absorption](#introduction-to-digestion-and-absorption)
- [Core Concepts: Digestion](#core-concepts-digestion)
- [Core Concepts: Absorption](#core-concepts-absorption)
- [Ayush's Note: Key Points for JEE/MEET](#ayushs-note-key-points-for-jeeneet)
- [Shortcut Formula: Calculating Nutrient Uptake](#shortcut-formula-calculating-nutrient-uptake)
- [Trap Questions: Common Misconceptions](#trap-questions-common-misconceptions)
- [Practice MCQs: Digestion and Absorption](#practice-mcqs-digestion-and-absorption)
...
3. [Core Concepts: Absorption](#core-concepts-absorption)
4. [Ayush's Note: Key Points for JEE/MEET](#ayushs-note-key-points-for-jeeneet)
5. [Shortcut Formula: Calculating Nutrient Uptake](#shortcut-formula-calculating-nutrient-uptake)
6. [Trap Questions: Common Misconceptions](#trap-questions-common-misconceptions)
7. [Practice MCQs: Digestion and Absorption](#practice-mcqs-digestion-and-absorption)
...
## <a id="core-concepts-digestion"></a>Core Concepts: Digestion
...
| Small Intestine | Lactase, sucrose, Maltese | Breaks down lactose, sucrose, and maltose into glucose and other simple sugars |

## <a id="core-concepts-absorption"></a>Core Concepts: Absorption

The process of absorption primarily occurs in the small intestine and can be summarized as follows:

1. **Passive Transport**: Nutrients like glucose, amino acids, and fatty acids are absorbed into the bloodstream through passive transport, which does not require energy.
...
3. **Facilitated Diffusion**: Some nutrients are absorbed through facilitated diffusion, where carrier proteins help transport molecules across the [cell](/blog/cell-the-unit-of-life-class-11-revision-notes-neet) membrane.
...
## <a id="shortcut-formula-calculating-nutrient-uptake"></a>Shortcut Formula: Calculating Nutrient Uptake
...
## <a id="practice-MCQs-digestion-and-absorption"></a>Practice MCQs: Digestion and Absorption
...
- **Mechanism of Digestion**: Salivary amylase breaks down starch into maltose, lipase breaks down triglycerides into fatty acids and glycerol.
   - **Gastric Juice**: Pepsin breaks down proteins into peptides, gastric amylase breaks down carbohydrates, and gastric lipase breaks down triglycerides.
   - **Pancreatic Juice**: Amylase breaks down carbohydrates, lipase breaks down triglycerides, trypsin breaks down proteins, and chymotrypsin breaks down peptides.
   - **Bile Juice**: Emulsifies fats, activates lipase, and absorbs fat-soluble vitamins.
   - **Small Intestine**: Most nutrient absorption occurs here, including carbohydrates, proteins, and fats.
   - **Large Intestine**: Water absorption, and storage and elimination of waste products.
   - **Vitamins**: Fat-soluble (A, D, E, K) and water-soluble (B, C).
   - **Minerals**: Macro (Na, K, Ca, Mg) and micro (Fe, Zn, Cu).
   - **Digestion and Absorption Disorders**: Diarrhea, constipation, malabsorption syndrome, and gastrointestinal infections.