...
- [Introduction to Hydrogen](#introduction-to-hydrogen)
- [Occurrence and Extraction of Hydrogen](#occurrence-and-extraction-of-hydrogen)
- [Properties of Hydrogen](#properties-of-hydrogen)
- [Hydrogen Compounds](#hydrogen-compounds)
- [Applications of Hydrogen](#applications-of-hydrogen)
...
2. [Occurrence and Extraction of Hydrogen](#occurrence-and-extraction-of-hydrogen)
3. [Properties of Hydrogen](#properties-of-hydrogen)
4. [Hydrogen Compounds](#hydrogen-compounds)
5. [Applications of Hydrogen](#applications-of-hydrogen)
6. [Shortcut Formula/Trick](#shortcut-formulatruck)
...
Hydrogen is [the lightest and most abundant chemical element in the universe](https://en.wikipedia.org/wiki/Hydrogen). It is a colorless, odorless, and highly flammable gas. Hydrogen has three isotopes: protium, deuterium, and tritium. It is a key component of water (H2O) and most organic compounds.




## <a id="occurrence-and-extraction-of-hydrogen"></a>Occurrence and Extraction of Hydrogen
...
where $ is the number of moles, $m$ is the mass of the compound, and $M$ is the molar mass of the compound.
...
Right answer: Hydrogen has three isotopes: protium, deuterium, and tritium.
...
2. Which of the following is a common hydrogen compound?
A) Water (H2O)
B) Ammonia (NH3)
C) Methane (CH4)
D) All of the above
...
3. What is the primary application of hydrogen fuel cells?
A) Power generation
B) Transportation
