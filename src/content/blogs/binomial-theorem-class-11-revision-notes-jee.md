...
> - **Binomial Theorem:** (a + b)ⁿ = BC₀ a + BC₁ a⁻¹b + BC₂ a⁻²b² + ... + act by.
> - **Number of Terms:** Total terms in expansion of (a + b)ⁿ is (n + 1).
> - **General Term (To₊₁):** act a⁻ʳ by.
> - **Middle Term(s):** 
>   - If n is even: T₍ₙ/₂ + ₁₎ is the middle term.
>   - If n is odd: T₍₍ₙ+₁₎/₂₎ and T₍₍ₙ+₃₎/₂₎ are two middle terms.
...
**The Binomial Theorem provides an elegant algebraic method for expanding expressions of the form (a + b)ⁿ using Pascal's Triangle and binomial coefficients. Master the General Term formula, Middle Term calculations, and properties of act to solve high-degree expansion problems in financial modeling and calculus. This [class](/blog/laws-of-motion-class-11-revision-notes-jee-neet) 11 Math Chapter 8 guide ensures total mastery for JEE and CBSE assessments.**
...
**(a + b)ⁿ = BC₀ a + BC₁ a⁻¹b + BC₂ a⁻²b² + ... + act by**
...
The (r+1)ᵗʰ term in the expansion of (a + b)ⁿ is called the general term and is denoted by **To₊₁**.
**To₊₁ = act a⁻ʳ by**
...
2.  **Case II: n is odd**
    There are two middle terms: **T₍₍ₙ+₁₎/₂₎** and **T₍₍ₙ+₃₎/₂₎**.
...
**Q2: Find the middle term in the expansion of (x + 3)⁸.**
**Answer:**
...
**Q3: Find the coefficient of x⁵ in (x + 3)⁸.**
**Answer:**
...
- [**External Reference:** [CERT Class 11 Math Chapter 8](https://ncert.nic.in/textbook.php?kemh1=8-16) (Authoritative Source)]
