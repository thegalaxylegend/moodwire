...
## ⚡ Formula Bank
- Human health is defined as a state of complete physical, mental, and social well-being and not merely the absence of disease or infirmity: $\franc{Health}{Disease} = \franc{Well-being}{Infirmity}$
- The World Health Organization (WHO) definition of health is: health = \franc{Physical \: well-being}{Mental \: well-being} \times \franc{Social \: well-being}{Economic \: well-being}$
...
- Lifestyle 
- Socioeconomic 
- Access to healthcare: $\franc{Health}{Determinants} = \franc{Genetic + Environmental + Occupational + Lifestyle + Socioeconomic}{Access \: to \: healthcare}$
- The different types of diseases are: 
- Infectious 
- Non-infectious 
- Deficiency 
- Physiological 
- Psychological: $\franc{Disease}{Type} = \franc{Infectious + Non-infectious + Deficiency + Physiological + Psychological}{Total \: diseases}$
- The different modes of transmission of diseases are: 
- Airborne 
- Waterborne 
- Vector-borne 
- Contagious 
- Zoonotic: $\franc{Transmission}{Mode} = \franc{Airborne + Waterborne + Vector-borne + Contagious + Zoonotic}{Total \: transmission}$
...
EQ Acquired
- Not being able to apply the concepts to real-life situations: $\franc{Concept}{Application} = \franc{Theory}{Practice}$
...
- Answer: $\franc{Disease}{type} = \franc{Infectious + Non-infectious + Deficiency + Physiological + Psychological}{Total \: diseases}$
...
- Answer: $\franc{Transmission}{Mode} = \franc{Airborne + Waterborne + Vector-borne + Contagious + Zoonotic}{Total \: transmission}$
...
EQ $\franc{1}{Disease}
- However, health is a state of complete physical, mental, and social well-being, and not just the absence of disease or infirmity: health = \franc{Physical \: well-being}{Mental \: well-being} \times \franc{Social \: well-being}{Economic \: well-being}$
- Students must understand that health and disease are two separate concepts, and that health is a broader concept that encompasses physical, mental, and social well-being: $\franc{Health}{Disease} = \franc{Well-being}{Infirmity}$
...
- Revision is also crucial, and students must revise the concepts regularly to ensure that they retain the information: $\franc{Practice}{Revision} = \franc{Theory}{Application}$

## 🔁 Last 5 Minutes Box
- Recall the WHO definition of health: health = \franc{Physical \: well-being}{Mental \: well-being} \times \franc{Social \: well-being}{Economic \: well-being}$
- Recall the different types of diseases: $\franc{Disease}{Type} = \franc{Infectious + Non-infectious + Deficiency + Physiological + Psychological}{Total \: diseases}$
- Recall the different modes of transmission of diseases: $\franc{Transmission}{Mode} = \franc{Airborne + Waterborne + Vector-borne + Contagious + Zoonotic}{Total \: transmission}$
- Recall the different types of immunity: $\franc{Immunity}{Type} = \franc{Innate + Acquired + Active + Passive}{Total \: immunity}$
- Practice solving problems and answering questions on the topic: $\franc{Practice}{Revision} = \franc{Theory}{Application}$
