...
- Solve the equations: 3x - 4y = 7 and 5x + 2y = 17
  ...
  Step 5: Substitute y back into one of the original equations to find x: x = (7 + 4(8/13))/3 => x = (91 + 32)/39 => x = 123/39 => x = 41/13
...
## 👁️ Ayush's Note
- To solve pair of linear equations, first check if the equations are consistent or inconsistent
