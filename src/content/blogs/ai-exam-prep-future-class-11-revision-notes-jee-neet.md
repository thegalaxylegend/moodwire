...
* **Introduction to Computer Science**: History, Generations, Types of Computers
* **Programming Methodology**: Algorithm, Flowchart, Pseudo Code
* **Python Programming**: Variables, Data Types, Operators, Control Structures, Functions
* **Object-Oriented Programming**: Classes, Objects, Inheritance, Polymorphism, Encapsulation
* **Data Structures**: Arrays, Lists, Tuples, Sets, Dictionaries
* **Computer Networks**: Types of Networks, Network Topology, IP Address, Protocols
* **Database Management System**: DBMS, DBMS, SQL, Queries
* **Cyber Security**: Threats, Vulnerabilities, Measures, Ethics
* **Emerging Trends**: AI, ML, IoT, Blockchain
