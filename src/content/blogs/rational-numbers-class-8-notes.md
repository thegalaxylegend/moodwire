...
- **Question 1:** Simplify the expression $\frac{3}{4} + \frac{1}{6}$.
  ...
  - So, $\frac{3}{4} = \frac{3 \times 3}{4 \times 3} = \frac{9}{12}$ and $\frac{1}{6} = \frac{1 \times 2}{6 \times 2} = \frac{2}{12}$.
...
- **Question 2:** Subtract $\frac{2}{5}$ from $\frac{3}{4}$.
  ...
  - So, $\frac{3}{4} = \frac{3 \times 5}{4 \times 5} = \frac{15}{20}$ and $\frac{2}{5} = \frac{2 \times 4}{5 \times 4} = \frac{8}{20}$.
