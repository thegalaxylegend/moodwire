...
![Ancient India Mahajanapadas Class 11 History Recap — CBSE 2026 Quick Guide](/blog-images/ancient-india-mahajanapadas-class-11-revision-notes-jee.webp)
...
- [Quick Revision & Recap: Ancient India - Mahajanapadas](#quick-revision-and-recap-ancient-india-mahajanapadas)
- [Ayush's Personal Note](#ayushs-personal-note)
- [JEE/MEET Data and Historical Context](#jeeneet-data-and-historical-context)
...
- **Notable Mahajanapadas**: Agatha, Koala, Keys, Fiji, Malley, Cheri, Vats, Kaushambi, Paschal, Mats ya, Kurukshetra, Gandhara, Bamboo, Shaky, Lichchhavi, and (suggestion limit reached)

As I, Ayush, recall from my history lessons, the Mahajanapadas marked a significant shift from the earlier tribal society to a more complex, state-level society. This period saw the rise of **urban centers**, **trade networks**, and **new religious movements** like Buddhism and Jainism.
...
The following table lists the 16 Mahajanapadas, their capitals, and notable rulers or features:
...
| Cheri | Ultimate |
| (suggestion limit reached) | (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) |
| Gandhara | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | (suggestion limit reached) | Siddhārtha Gautama (Buddha) |
| (suggestion limit reached) | (suggestion limit reached) |
| (suggestion limit reached) | Ujjain/(suggestion limit reached) |
...
* **Important (suggestion limit reached)**: (suggestion limit reached), (suggestion limit reached), (suggestion limit reached), Gandhara
* **(suggestion limit reached)**: (suggestion limit reached) (544-492 BCE), (suggestion limit reached) (492-460 BCE), Pataliputra capital
* **(suggestion limit reached)**: (suggestion limit reached) capital, (suggestion limit reached) king
* **(suggestion limit reached)**: (suggestion limit reached) capital, (suggestion limit reached) king
* **Gandhara**: (suggestion limit reached) capital
