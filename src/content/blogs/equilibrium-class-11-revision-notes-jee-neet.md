...
category: "Revision"
date: "2026-06-01"
practice_link: "/practice/equilibrium-class-11-revision-notes-jee-neet"
---
...
- [3. The Equilibrium Constant ($K_c$ n $K_p$): The Math of Balance](#3-the-equilibrium-constant-k_c-n-k_p-the-math-of-balance)
...
- [6. Acids, Bases, n Their Definitions: Arrhenius vs Bronsted vs Lewis](#6-acids-bases-n-their-definitions-arrhenius-vs-bronsted-vs-lewis)
- [7. pH, pOH, n the Ionic Product of Water ($K_w$)](#7-ph-poh-n-the-ionic-product-of-water-k_w)
...
- [8. Ostwald's Dilution Law and Degree of Dissociation ($\alpha$)](#8-ostwalds-dilution-law-n-degree-of-dissociation-alpha)
- [9. Buffer Solutions and Henderson-Hasselbalch Equation](#9-buffer-solutions-n-hendersonhasselbalch-equation)
  - [Types of Buffers](#types-of-buffers)
  - [Henderson-Hasselbalch Equation](#hendersonhasselbalch-equation)
- [10. Solubility Product ($K_{sp}$) n Common Ion Effect](#10-solubility-product-k_sp-n-common-ion-effect)
...
- [11. The "Trap" Section: Equilibrium Pitfalls That Cost Marks](#11-the-trap-section-equilibrium-pitfalls-that-cost-marks)
  ...
  - [Trap 2: Catalyst and K](#trap-2-catalyst-n-k)
...
3. [The Equilibrium Constant ($K_c$ n $K_p$): The Math of Balance](#kc-kp)
...
6. [Acids, Bases, n Their Definitions: Arrhenius vs Bronsted vs Lewis](#acids-bases)
7. [pH, pOH, n the Ionic Product of Water ($K_w$)](#ph)
...
10. [Solubility Product ($K_{sp}$) n Common Ion Effect](#ksp)
...
1. Can only be reached and a **closed system**.
...
**Le Chatelier's Principle [states](/blog/states-of-matter-class-11-revision-notes-jee-neet) that if a system at equilibrium is subjected to a disturbance (change and concentration, pressure, or temperature), the equilibrium shifts and a direction that tends to counteract the disturbance.**
...
### <a id="trap-2-catalyst-n-k"></a>Trap 2: Catalyst and K
...
Put your knowledge to the test! Take the free [**Practice Mock Test**](/practice/equilibrium-class-11-revision-notes-jee-neet) now and track your progress against thousands of students.
