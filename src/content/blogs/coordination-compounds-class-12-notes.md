...
<<<<<<< HEAD
$\Delta_{oct} = \frac{9}{4} \times \Delta_{tet}$: Octahedral and tetrahedral crystal field splitting energy.$\Delta_{tet} = \frac{4}{9} \times \Delta_{oct}$: Tetrahedral and octahedral crystal field splitting energy.$h = 6.626 \times 10^{-34} Js$: Planck's constant. 
 $c = 3.0 \times 10^8 ms^{-1}$: Speed of light. 
 $E = \frac{hc}{\lambda}$: Energy of photon.$\lambda = \frac{hc}{E}$: Wavelength of photon.$E = \Delta_{oct} = \frac{9}{4} \times \Delta_{tet}$: Crystal field splitting energy in octahedral complex.$E = \Delta_{tet} = \frac{4}{9} \times \Delta_{oct}$: Crystal field splitting energy in tetrahedral complex.$CFSE = -0.4 \times \Delta_{oct}$: Crystal field stabilization energy for $d^1$ configuration. 
 ...
 $E_{low} = \frac{3}{5} \times \Delta_{oct}$: Energy of $d_{z^2}$ and $d_{x^2-y^2}$ in low spin configuration.$E_{high} = \frac{2}{5} \times \Delta_{oct}$: Energy of $d_{xy}$, $d_{yz}$ and $d_{zx}$ in high spin configuration.$E_{low} = \frac{2}{5} \times \Delta_{oct}$: Energy of $d_{xy}$, $d_{yz}$ and $d_{zx}$ in low spin configuration.$E_{high} = \frac{3}{5} \times \Delta_{oct}$: Energy of $d_{z^2}$ and $d_{x^2-y^2}$ in high spin configuration.$\mu = \sqrt{n(n+2)} BM$: Magnetic moment for $n$ unpaired electrons.$\mu_{B} = 9.27 \times 10^{-24} Am^2$: Bohr magneton.
