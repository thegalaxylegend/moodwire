...
- [Environmental Chemistry Class 11 Notes](#environmental-chemistry-class-11-notes)
- [Introduction to Environmental Chemistry](#introduction-to-environmental-chemistry)
...
I once made a mistake and my JEE preparation y not giving enough importance to environmental [chemistry](/blog/organic-chemistry-basic-principles-class-11-revision-notes-jee-neet). I used to think that it's a simple topic and doesn't require much practice. But, I realized my mistake when I saw the weightage of environmental [chemistry](/blog/organic-chemistry-basic-principles-class-11-revision-notes-jee-neet) and the JEE exam. I had to work hard to catch up and make sure I didn't make the same mistake again. My advice to you is to not underestimate the importance of environmental [chemistry](/blog/organic-chemistry-basic-principles-class-11-revision-notes-jee-neet) and to practice it regularly.
</div>
...
A) Natural disasters
B) Vehicles and industrial activities
C) Domestic waste
D) Agricultural runoff
Answer: B) Vehicles and industrial activities
2. What is the effect of water pollution on human health?
A) It only affects aquatic life
B) It can cause the spread of waterborne diseases
C) It can cause climate change
D) It can cause soil pollution
Answer: B) It can cause the spread of waterborne diseases
3. What is the formula for calculating the pH of a solution?
A) $\text{pH} = -\log_{10}[\text{H}^+]$
B) $\text{pH} = \log_{10}[\text{H}^+]$
C) $\text{pH} = -\log_{10}[\text{OH}^-]$
D) $\text{pH} = \log_{10}[\text{OH}^-]$
Answer: A) $\text{pH} = -\log_{10}[\text{H}^+]$
4. What is the main source of soil pollution?
...
Put your knowledge to the test! Take the free [**Practice Mock Test**](/class-11/biology/environmental-[chemistry](/blog/organic-chemistry-basic-principles-class-11-revision-notes-jee-neet)-class-11-revision-notes-neet) now and track your progress against thousands of students.
