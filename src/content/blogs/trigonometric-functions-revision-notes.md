...
> - **ASTC Rule:** 
>   - **A**ll (+ve) in 1st Quad.
>   - **S**ine (+ve) in 2nd Quad.
>   - **T**an (+ve) in 3rd Quad.
>   - **C**os (+ve) in 4th Quad.
> - **Identities:** sin²x + cos²x = 1; 1 + tan²x = sec²x; 1 + cot²x = cosec²x.
> - **Periodicity:** Sin, Cos, Sec, Cosec repeat after 2π. Tan and Cot repeat after π.
...
**Q2: Find the radian measure of -47° 30'.**
**Answer:**
- 30' = (1/2)° = 0.5°.
- So, -47° 30' = -47.5°.
- In radians = -47.5 × (π/180) = **-19π/72**.

**Q3: Prove that cos³x + sin³x / cos x + sin x = 1 - sin x cos x.**
**Answer:**
