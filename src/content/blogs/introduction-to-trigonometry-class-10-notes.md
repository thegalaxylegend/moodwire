...
- If $\\\sin \theta = \frac{3}{5}$, find the value of $\\\cos \theta.$
  - Using the Pythagorean identity $\\\sin^2 \theta + \\\cos^2 \theta = 1$, we get $\left(\frac{3}{5}\r\r\right)^2 + \\\cos^2 \theta = 1$.
...
**Answer: B) $\frac{\sqrt{3}}{2}$, since $\\\sin^2 \theta + \\\cos^2 \theta = 1$, we get $\left(\frac{1}{2}\r\r\right)^2 + \\\cos^2 \theta = 1$, which gives $\\\cos^2 \theta = \frac{3}{4}$, and therefore $\\\cos \theta = \frac{\sqrt{3}}{2}$**
...
**Answer: B) $\frac{\sqrt{5}}{3}$, since $\\\sin^2 \theta + \\\cos^2 \theta = 1$, we get $\\\sin^2 \theta + \left(\frac{2}{3}\r\r\right)^2 = 1$, which gives $\\\sin^2 \theta = \frac{5}{9}$, and therefore $\\\sin \theta = \frac{\sqrt{5}}{3}$**
