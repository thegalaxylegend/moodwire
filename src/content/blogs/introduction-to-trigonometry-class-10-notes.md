...
## ✏️ 3 Solved PYQs
- In a right-angled triangle, the length of the hypotenuse is $10$ cm and one of the acute angles is $60^\circ.$ Find the length of the side opposite the $60^\circ$ angle.
  - Let the length of the side opposite the $60^\circ$ angle be $x$.
  - Using the formula $\\\\\sin \theta = \frac{\text{opposite side}}{\text{hypotenuse}}$, we get $\\\\\sin 60^\circ = \frac{x}{10}$.
  - Since $\\\\\sin 60^\circ = \frac{\sqrt{3}}{2}$, we have $\frac{\sqrt{3}}{2} = \frac{x}{10}$.
  - Solving for $x$, we get $x$ = $5\sqrt{3}.$
- In a right-angled triangle, the length of one of the acute angles is $30^\circ.$ Find the value of $\tan 30^\circ.$
  - Let the length of the side opposite the $30^\circ$ angle be $x$ and the length of the side adjacent to the $30^\circ$ angle be $y$.
  - Using the formula $\tan \theta = \frac{\text{opposite side}}{\text{adjacent side}}$, we get $\tan 30^\circ = \frac{x}{y}$.
  - Since $\tan 30^\circ = \frac{1}{\sqrt{3}}$, we have $\frac{x}{y} = \frac{1}{\sqrt{3}}$.
  - Therefore, the value of $\tan 30^\circ$ is $\frac{1}{\sqrt{3}}$.
- If $\\\\\sin \theta = \frac{3}{5}$, find the value of $\\\\\cos \theta.$
  - Using the Pythagorean identity $\\\\\sin^2 \theta + \\\\\cos^2 \theta = 1$, we get $\left(\frac{3}{5}\r\r\r\r\right)^2 + \\\\\cos^2 \theta = 1$.
  - Solving for $\\\\\cos^2 \theta,$ we get $\\\\\cos^2 \theta = 1 - \frac{9}{25} = \frac{16}{25}$.
  - Taking the square root of both sides, we get $\\\\\cos \theta = \pm \frac{4}{5}$.
...
**Answer: B) $\frac{\sqrt{3}}{2}$, since $\\\\\sin^2 \theta + \\\\\cos^2 \theta = 1$, we get $\left(\frac{1}{2}\r\r\r\r\right)^2 + \\\\\cos^2 \theta = 1$, which gives $\\\\\cos^2 \theta = \frac{3}{4}$, and therefore $\\\\\cos \theta = \frac{\sqrt{3}}{2}$**
...
**Answer: B) $\frac{\sqrt{5}}{3}$, since $\\\\\sin^2 \theta + \\\\\cos^2 \theta = 1$, we get $\\\\\sin^2 \theta + \left(\frac{2}{3}\r\r\r\r\right)^2 = 1$, which gives $\\\\\sin^2 \theta = \frac{5}{9}$, and therefore $\\\\\sin \theta = \frac{\sqrt{5}}{3}$**
