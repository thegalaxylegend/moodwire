...
![Quadratic Equations Class 10 Mathematics Recap — CBSE 2026 Quick Guide](/blog-images/quadratic-equations-class-10-notes.webp)
...
**Answer:** D) Using the product of roots formula $\alpha \beta = \frac{c}{a}$, we get the product of roots as $\frac{c}{a}$.

---

**5. Solve the equation $2x^2 + 5x - 3 = 0$ using the quadratic formula.**
