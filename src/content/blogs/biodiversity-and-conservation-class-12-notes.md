...
- $Shannon-Wiener\ Diversity\ Index = - \sum_{i=1}^{s} \frac{n_i}{N} \ln \frac{n_i}{N}$, where $n_i$ is the number of individuals of the $i^{th}$ species and $N$ is the total number of individuals.
- $Simpson's\ Diversity\ Index = 1 - \sum_{i=1}^{s} \frac{n_i(n_i - 1)}{N(N - 1)}$, where $n_i$ is the number of individuals of the $i^{th}$ species and $N$ is the total number of individuals.
