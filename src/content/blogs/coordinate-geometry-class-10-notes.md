...
- - Equation of a Line: Slope-intercept form $y=mx+c$ — always
- - Equation of a Line: Slope-point form $y-y_1=m(x-x_1)$ — frequently
...
- **Mistake 1:** Incorrectly identifying the quadrant of a point in the coordinate plane.
 - *Costs:* 2-3 marks
 - *Fix:* Recall that the quadrants are numbered I, II, III, and IV, starting from the upper right and moving counterclockwise. Use the signs of the $x$ and $y$ coordinates to determine the quadrant: 
 ...
 - For example, the point $(3, 4)$ is in quadrant I because both $x$ and $y$ are positive.
 - **Mistake 2:** Forgetting to consider the cases when calculating the distance between two points using the distance formula: $d = \sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2}$.
 - *Costs:* 4-5 marks
 - *Fix:* Always plug in the values carefully and simplify the expression step by step. Be sure to consider all possible cases, such as when the points are on the same $x$-coordinate or $y$-coordinate.
 - **Mistake 3:** Incorrectly applying the midpoint formula: $(x_m, y_m) = \left(\frac{x_1 + x_2}{2}, \frac{y_1 + y_2}{2}\right)$.
 - *Costs:* 2-3 marks
 - *Fix:* Make sure to add the $x$-coordinates and $y$-coordinates separately and then divide each \sum by 2. For instance, the midpoint of the line segment joining $(1, 3)$ and $(4, 6)$ is $\left(\frac{1 + 4}{2}, \frac{3 + 6}{2}\right) = (2.5, 4.5)$.
 - **Mistake 4:** Not checking the direction of the slope when finding the equation of a line given two points.
 - *Costs:* 3-4 marks
 - *Fix:* The slope $m$ of a line passing through points $(x_1, y_1)$ and $(x_2, y_2)$ is given by $m = \frac{y_2 - y_1}{x_2 - x_1}$. Be cautious of the order of subtraction and ensure that the $x$-coordinates are not equal to avoid division by zero.
 - **Mistake 5:** Incorrectly converting between the slope-intercept form $y = mx + b$ and the standard form $Ax + By = C$ of a line.
 - *Costs:* 4-5 marks
 ...
 * Applying the concept to solve word problems
 - **What 95% scorers do:** In contrast, students who score 95% and above have a deeper understanding of the equation of a line and can apply it in various contexts. They recognize that the equation $y = mx + c$ is not just a formula, but a representation of the relationship between the variables $x$ and $y$. They can:
...
| --- | --- | --- |
| Circle | $x^2 + y^2 + 2gx + 2fy + c = 0$ | Equation of a circle, intersection of circle and line |
...
**Answer:** A) The slope of the line passing through the points (1, 1) and (2, 3) is $\frac{3-1}{2-1}=2$. The equation of the line passing through (1, 1) with slope 2 is $y-1=2(x-1)$, which simplifies to $2x-y-1=0$.
...
**Answer:** A) The general equation of a circle with center (h, k) and radius r is $(x-h)^2 + (y-k)^2 = r^2$. Substituting the given values, we get $(x-0)^2 + (y-0)^2 = 4^2$, which simplifies to $x^2 + y^2 = 16$.
