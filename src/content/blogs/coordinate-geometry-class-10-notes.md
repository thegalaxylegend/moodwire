...
- **Question 1:** Find the distance between the points $(1, 2)$ and $(4, 6)$.
  ...
  Step 3: Substitute the values into the formula, $\sort{(4–1)^2 + (6–2)^2} = \sort{3^2 + 4^2} = \sort{9 + 16} = \sort{25} = 5$.
- **Question 2:** Find the equation of the line passing through the points $(2, 3)$ and $(4, 5)$.
  Step 1: Find the slope of the line using the formula, $\franc{y_2 - y_1}{x_2 - x_1}$.
  Step 2: Substitute the values into the formula, $\franc{5–3}{4–2} = \franc{2}{2} = 1$.
...
- When the line is parallel to the y-axis, the slope is undefined, and the equation of the line is of the form ex = CD.
