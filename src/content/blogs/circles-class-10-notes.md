...
category: "Exam Notes"
date: "2026-04-20"
practice_link: "/practice/circles-class-10-notes"
manualReview: false
---

## ⚡ Formula Bank
- The equation of a circle with centre $(h, k)$ and radius $r$ is given by $(x - h)^2 + (y - k)^2 = r^2$
- The equation of a circle with centre $(0, 0)$ and radius $r$ is given by $x^2 + y^2 = r^2$
- The general equation of a circle is given by $x^2 + y^2 + 2gx + 2fy + c = 0$, where the centre is $(-g, -f)$ and the radius is $\sqrt{g^2 + f^2 - c}$
- The equation of a circle passing through the points $(x_1, y_1)$ and $(x_2, y_2)$ is given by $(x - x_1)(x - x_2) + (y - y_1)(y - y_2) = 0$
- The length of the tangent from an external point $(x_1, y_1)$ to a circle with centre $(h, k)$ and radius $r$ is given by $\sqrt{(x_1 - h)^2 + (y_1 - k)^2 - r^2}$
...
- The angle subtended by an arc at the centre is twice the angle subtended by the arc at any point on the circumference
- The equation of the tangent to a circle at a point $(x_1, y_1)$ is given by $xx_1 + yy_1 + g(x + x_1) + f(y + y_1) + c = 0$

 
## 🪤 The 5 Mistakes That Cost Marks
- Not checking if the given equation represents a circle
- Not finding the centre and radius of the circle from the given equation
...
- Not using the properties of circles, such as the angle between a tangent and a chord, and the angle subtended by an arc at the centre
...
- **Question 1:** Find the equation of the circle passing through the points $(1, 2)$, $(3, -4)$, and $(5, 2)$.
  ...
  - Step 2: Substitute the given points into the equation to get three equations in terms of $g$, $f$, and $c$.
  - Step 3: Solve the three equations simultaneously to find the values of $g$, $f$, and $c$.
  - Step 4: Substitute the values of $g$, $f$, and $c$ into the general equation to get the equation of the circle.
- **Question 2:** Find the length of the tangent from the point $(4, 3)$ to the circle $x^2 + y^2 - 4x - 6y - 3 = 0$.
  - Step 1: Find the centre and radius of the circle from the given equation.
...
- To check if the given equation represents a circle, we need to check if the coefficients of $x^2$ and $y^2$ are equal and non-zero.
- If the coefficients of $x^2$ and $y^2$ are equal and non-zero, then the equation represents a circle.
...
- Use the properties of circles, such as the angle between a tangent and a chord, and the angle subtended by an arc at the centre.
...
- Revise the properties of circles, such as the angle between a tangent and a chord, and the angle subtended by an arc at the centre.
- Practice solving problems to get a good understanding of the concepts.
...
- A) $\sqrt{3^2 + 4^2 - 4 \cdot 3 - 6 \cdot 4 - 3}$
- B) $\sqrt{3^2 + 4^2 + 4 \cdot 3 + 6 \cdot 4 + 3}$
- C) $\sqrt{3^2 + 4^2 - 4 \cdot 3 + 6 \cdot 4 - 3}$
- D) $\sqrt{3^2 + 4^2 + 4 \cdot 3 - 6 \cdot 4 - 3}$
**Answer: A) $\sqrt{3^2 + 4^2 - 4 \cdot 3 - 6 \cdot 4 - 3}$**

**3. What is the equation of the tangent to the circle $x^2 + y^2 - 4x - 6y - 3 = 0$ at the point $(2, 1)$?**
- A) $xx_1 + yy_1 + g(x + x_1) + f(y + y_1) + c = 0$
- B) $xx_1 - yy_1 + g(x - x_1) + f(y - y_1) + c = 0$
- C) $xx_1 + yy_1 - g(x + x_1) - f(y + y_1) + c = 0$
- D) $xx_1 - yy_1 - g(x - x_1) - f(y - y_1) + c = 0$
**Answer: A) $xx_1 + yy_1 + g(x + x_1) + f(y + y_1) + c = 0$**
...
**5. What is the angle subtended by an arc at the centre?**
