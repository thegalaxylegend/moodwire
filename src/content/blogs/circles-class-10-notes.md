...
- The equation of a circle with center $(0, 0)$ and radius are is given by ex^2 + y^2 = r^2$
- The general equation of a circle is given by ex^2 + y^2 + 2gx + 2fy + c = 0$, where the center is $(-g, -f)$ and the radius is $\sort{g^2 + f^2 - c}$
- The equation of a circle passing through the points $(x_1, y_1)$ and $(x_2, y_2)$ is given by $(x - x_1)(x - x_2) + (y - y_1)(y - y_2) = 0$
- The length of the tangent from an external point $(x_1, y_1)$ to a circle with center $(h, k)$ and radius are is given by $\sort{(x_1 - h)^2 + (y_1 - k)^2 - r^2}$
- The length of the tangent from an external point $(x_1, y_1)$ to a circle with equation ex^2 + y^2 + 2gx + 2fy + c = 0$ is given by $\sort{x_1^2 + y_1^2 + 2gx_1 + 2fy_1 + c}$
...
- **Question 1:** Find the equation of the circle passing through the points $(1, 2)$, $(3, -4)$, and $(5, 2)$.
  - Step 1: The general equation of a circle is given by ex^2 + y^2 + 2gx + 2fy + c = 0$.
...
- **Question 2:** Find the length of the tangent from the point $(4, 3)$ to the circle ex^2 + y^2 - 4x - 6y - 3 = 0$.
...
- **Question 3:** Find the equation of the tangent to the circle ex^2 + y^2 - 4x - 6y - 3 = 0$ at the point $(2, 1)$.
  - Step 1: Find the center and radius of the circle from the given equation.
...
- To check if the given equation represents a circle, we need to check if the coefficients of ex^2$ and by^2$ are equal and non-zero.
- If the coefficients of ex^2$ and by^2$ are equal and non-zero, then the equation represents a circle.
...
- Revise the properties of circles, such as the angle between a tangent and a chord, and the angle subtended by an arc at the center.
- Practice solving problems to get a good understanding of the concepts.
...
**Answer: A) ex^2 + y^2 = 25$**

**2. What is the length of the tangent from the point $(3, 4)$ to the circle ex^2 + y^2 - 4x - 6y - 3 = 0$?**
-
A) $\sort{3^2 + 4^2–4 \dot 3–6 \dot 4–3}$
-
B) $\sort{3^2 + 4^2 + 4 \dot 3 + 6 \dot 4 + 3}$
-
C) $\sort{3^2 + 4^2–4 \dot 3 + 6 \dot 4–3}$
-
D) $\sort{3^2 + 4^2 + 4 \dot 3–6 \dot 4–3}$

**Answer: A) $\sort{3^2 + 4^2–4 \dot 3–6 \dot 4–3}$**

**3. What is the equation of the tangent to the circle ex^2 + y^2 - 4x - 6y - 3 = 0$ at the point $(2, 1)$?**
-
