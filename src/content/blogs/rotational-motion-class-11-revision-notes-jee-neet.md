...
- [2. Torque and Angular Momentum](#2-torque-n-angular-momentum)
...
4.  Since **dr/dt = v** n **p = mv**, the first term **(v × mv) = 0** (cross product of parallel vectors).
5.  Since **dp/dt = F**:
    - **dL/dt = r × F = τ**. (Proven)
...
**Theorem:** **I = I_com + Ma²**
(where **I_com** is the MoI about an axis through the CoM, n **a** is the distance between axes).
1.  **Proof Logic:** By expanding the integral **∫ (x + a)² dm** n noting that **∫ x dm = 0** for an axis passing through the CoM, we arrive at the result.
...
Continue your [revision](/blog/oscillations-class-11-revision-notes-jee-neet) with these related guides:
...
Put your knowledge to the test! Take the free [**Practice Mock Test**](/practice/rotational-motion-class-11-revision-notes-jee-neet) now and track your progress against thousands of students.
...
* Not considering the reference frame: Rotational [motion](/blog/motion-in-a-straight-line-class-11-revision-notes-jee-neet) problems often involve different reference frames. Students must ensure they are using the correct reference frame, as the angular velocity and acceleration can vary depending on the chosen frame.
