...
- **The Civil War Trigger:** (Majoritarian Laws) + (Ethnic Tension) + (Political Deadlock) → Civil War.
...
- ✅: Prudential = Calculation of outcomes (reduces conflict). Moral = Intrinsic value (spirit of democracy).
