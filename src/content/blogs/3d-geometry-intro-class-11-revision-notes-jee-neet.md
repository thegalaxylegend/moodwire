...
- The distance of a point $(x_1, y_1, z_1)$ from a plane $ax + by + cz + d = 0$ is $\frac{|ax_1 + by_1 + cz_1 + d|}{\sqrt{a^2 + b^2 + c^2}}$
- The angle between two lines with direction ratios $a_1, b_1, c_1$ and $a_2, b_2, c_2$ is given by $\cos \theta = \frac{a_1a_2 + b_1b_2 + c_1c_2}{\sqrt{a_1^2 + b_1^2 + c_1^2} \sqrt{a_2^2 + b_2^2 + c_2^2}}$
...
- For NEET, use the formula for the equation of a plane passing through three points: $\frac{x}{a} + \frac{y}{b} + \frac{z}{c} = 1$
...
**5. Question:** Find the distance of the point $(1, 2, 3)$ from the plane $x + y + z = 6$.
- A) $\frac{1}{\sqrt{3}}$
- B) $\frac{2}{\sqrt{3}}$
- C) $\frac{3}{\sqrt{3}}$
- D) $\frac{4}{\sqrt{3}}$
