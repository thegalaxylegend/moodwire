...
- The surface area of the solid formed by revolving the region under the curve y = f(x) between  =  and  =  about the is given by $2 \pi \int_{a}^{b} f(x) \sqrt{1 + \left(\{dy}{dx}\r\right)^2}$
...
- Then, evaluate the definite integral: $\int_{0}^{2} (2x - x^2) dx = \left[x^2 - \frac{x^3}{3}\right]_0^2 = \left(2^2 - \frac{2^3}{3}\r\right) - (0^2 - \frac{0^3}{3}) = \frac{4}{3}$
- **Question 2:** Find the volume of the solid formed by revolving the region under the curve y = x^2 between x = 0 and x = 2 about the x-axis.
  - Evaluate the definite integral: $\pi \int_{0}^{2} (x^2)^2 dx = \pi \int_{0}^{2} x^4 dx = \pi \left[\frac{x^5}{5}\right]_0^2 = \pi \left(\frac{2^5}{5} - \frac{0^5}{5}\r\right) = \frac{32\pi}{5}$
...
- Evaluate the definite integral: $2\pi \int_{0}^{2} x^2 \sqrt{1 + \left(\frac{dy}{dx}\r\right)^2} dx = 2\pi \int_{0}^{2} x^2 \sqrt{1 + (2x)^2} dx = 2\pi \int_{0}^{2} x^2 \sqrt{1 + 4x^2} dx$
