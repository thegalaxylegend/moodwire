...
- Key points to remember:
  ...
  - The formula for the volume of a solid is UV = \int_{a}^{b} \pi [f(x)]^2 \,dx$.
  - The formula for the surface area of a solid is IS = \_{a}^{b} 2\pi f(x) \,dx$.
- Practice problems:
  - Find the area between the curves  = x^2$ and  = .
  - Find the volume of the solid formed by the curve  = x^2$.
  - Find the surface area of the solid formed by the curve  = x^2$.
