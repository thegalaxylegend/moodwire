...
- The surface area of the solid formed by revolving the region under the curve y = f(x) between  =  and  =  about the  is given by $2 \pi \int_{a}^{b} f(x) \sqrt{1 + \left(\{dy}{dx}\right)^2}$
