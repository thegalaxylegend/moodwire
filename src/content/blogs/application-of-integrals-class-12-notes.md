...
- The formula for the volume of a solid is $V = \int_{a}^{b} \pi [f(x)]^2 \,dx$.
- The formula for the surface area of a solid is $S = \int_{a}^{b} 2\pi f(x) \,dx$.
- Key points to remember:
...
- Practice problems:
  ...
  - Find the volume of the solid formed by the curve $y = x^2$.
  - Find the surface area of the solid formed by the curve $y = x^2$.
...
- Key points to remember:
  - The formula for the surface area is $S = \int_{a}^{b} 2\pi f(x) \,dx$.
...
- Practice problems:
  - Find the surface area of the solid formed by the curve $y = x^2$.
  - Find the surface area of the solid formed by the curve $y = x$.
...
- Key points to remember:
  - The formula for the volume is $V = \int_{a}^{b} \pi [f(x)]^2 \,dx$.
  - The volume can be used to find the volume of a sphere, the volume of a cylinder, and the volume of a cone.
- Practice problems:
  - Find the volume of the solid formed by the curve $y = x^2$.
  - Find the volume of the solid formed by the curve $y = x$.
...
- Key points to remember:
  ...
  - It is used to find the definite integral of a function.
- Practice problems:
  - Evaluate the definite integral of $f(x) = x^2$ from $x = 0$ to $x = 2$.
  - Evaluate the definite integral of $f(x) = x$ from $x = 0$ to $x = 1$.
