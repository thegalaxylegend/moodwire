...
category: "Revision"
date: "2026-03-28"
practice_link: "/practice/thermodynamics-class-11-revision-notes-neet"
---
...
> - **Carnot Efficiency:** η = 1 - T2/T1. (T1 = source, T2 = sink).
...
4.  **Final Result:** **η = 1 - (T2 / T1)**. (Proven)
**Conclusion:** Efficiency depends *only* on the temperatures of the source and sink.
...
Put your knowledge to the test! Take the free [**Practice Mock Test**](/practice/thermodynamics-class-11-revision-notes-neet) now and track your progress against thousands of students.
