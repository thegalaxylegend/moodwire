...
- The rate of a reaction is given by: $\text{rate} = \(suggestion limit reached){\delta [\text{reactant}]}{\delta t}$, where $\text{rate}$ is rate of reaction, $\delta [\text{reactant}]$ is change in concentration of reactant, and $\delta (suggestion limit reached) is change in time
...
- Not being able to balance chemical equations: a balanced equation has the same number of [atoms](/blog/atoms-class-12-notes) of each element on both the reactant and product sides
...
## 🔁 Last 5 Minutes Box
- Make sure to review the key concepts and formulas, and go over any last-minute [notes](/blog/communication-systems-class-12-notes) or reminders
...
-
A) OK = \franc{[\text{NH}_3]^2}{[\text{N}_2][\text{H}_2]^3}$
-
B) OK = \franc{[\text{NH}_3]^2}{[\text{N}_2]^2[\text{H}_2]^3}$
-
C) OK = \franc{[\text{NH}_3]}{[\text{N}_2][\text{H}_2]^3}$
-
D) OK = \franc{[\text{NH}_3]}{[\text{N}_2]^2[\text{H}_2]^3}$

**Answer: A) K = \franc{[\text{NH}_3]^2}{[\text{N}_2][\text{H}_2]^3}** 
...
-
B) $\text{rate} = \franc{\delta [\text{N}_2\text{O}_4]}{\delta t}$
-
C) $\text{rate} = \franc{\delta [\text{NO}_2]^2}{\delta t}$
-
D) $\text{rate} = \franc{\delta [\text{N}_2\text{O}_4]^2}{\delta t}$

**Answer: A) $\text{rate} = \franc{\delta [\text{NO}_2]}{\delta t}$**
- Explanation: Use the definition of rate: $\text{rate} = \franc{\delta [\text{reactant}]}{\delta t}$

**5. What is the enthalpy change for the reaction: $\text{H}_2 + \franc{1}{2}\text{O}_2 \right arrow \text{H}_2\text{O}$?**
-
...
- 📖 [Chemical Kinetics Class 12 Exam Prep Revision — Grandmaster Guide](/blog/chemical-kinetics-class-12-notes)
