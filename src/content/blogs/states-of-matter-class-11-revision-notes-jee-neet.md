...
- **Ideal Gas**: $PV = nRT$. $R = 8.314 \text{ J/mol·K} = 0.0821 \text{ L·atm/mol·K}$.
- **Boyle's Law**: $P \propto 1/V$ (constant T). **Charles's Law**: $V \propto T$ (constant P).
- **Graham's Law**: Rate of diffusion $\propto 1/\sqrt{M}$.
- **Dalton's Law**: $P_{total} = P_1 + P_2 + ...$
- **Real Gases**: $Z = PV/nRT$. $Z=1$ (ideal), $Z<1$ (attraction), $Z>1$ (repulsion).
