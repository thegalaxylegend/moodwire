...
- [The Kinematics and Force Traps](#the-kinematics-and-force-traps)
  - [1. Forgetting to Isolate the System in FBDs](#1-forgetting-to-isolate-the-system-in-fbds)
  ...
  - [4. Mass vs Weight Confusion in Formulas](#4-mass-vs-weight-confusion-in-formulas)
  - [5. Getting the Normal Force Wrong on Inclines](#5-getting-the-normal-force-wrong-on-inclines)
- [The Tension and Pulley Traps](#the-tension-and-pulley-traps)
  - [6. Variable Tension in Accelerating Ropes](#6-variable-tension-in-accelerating-ropes)
  - [7. The Movable Pulley Constraint Error](#7-the-movable-pulley-constraint-error)
  - [8. Apparent Weight in Elevators](#8-apparent-weight-in-elevators)
- [The Friction Traps](#the-friction-traps)
  ...
  - [10. Ignoring Pseudo Forces in Rotating Frames](#10-ignoring-pseudo-forces-in-rotating-frames)
...
Plugging in mass ($m = 5$ kg) instead of weight ($W = mg = 50$ N) when calculating Normal Force or Tension.
...
**The Fix:** Tension is only constant in *massless* or ideal ropes. If the rope has mass $M$ and accelerates, tension decreases linearly from the pulling end to the trailing end.

### <a id="7-the-movable-pulley-constraint-error"></a>7. The Movable Pulley Constraint Error
In a movable pulley system, if a block attached to the pulley moves by distance $x$, the string must be pulled by distance $2x$. Students often assume both blocks have the same acceleration ($a$).
**The Fix:** Always write out the length constraint equation ($L = x_1 + 2x_2$) and differentiate twice to find the relationship between accelerations ($a_1 = -2a_2$).

### <a id="8-apparent-weight-in-elevators"></a>8. Apparent Weight in Elevators
...
**The Fix:** Always calculate the limiting static friction first. If $F_{applied} < f_{s,max}$, the body does not move, and the actual friction force equals $F_{applied}$, *not* $\mu_s N$.

### <a id="10-ignoring-pseudo-forces-in-rotating-frames"></a>10. Ignoring Pseudo Forces in Rotating Frames
