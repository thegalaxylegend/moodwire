...
- **Explanation:** The basic strength of amines depends on the availability of lone pair of electrons on the nitrogen atom. Alkyl amines are more basic than aryl amines due to the $+IN effect of the alkyl group. Among aryl amines, the basicity decreases with the increase in the electron withdrawing power of the substituent.
...
- **Question 3:** The APK_by value of $\text{CH}_3\text{NH}_2$ is $3.36$. The APK_a value of $\text{CH}_3\text{NH}_3^+$ is
- A) $10.64$
- B) $3.36$
- C) $6.36$
- D) $9.36$
...
- The APK_a value of the conjugate acid of an amine is a measure of its acidity.
