...

{
 ...
 "body": "- **Q1:** Solve for $x$: $\frac{x}{2} - \frac{1}{5} = \frac{x}{3} + \frac{1}{4}$
...
- **Q2:** The \sum of two numbers is 95. If one number exceeds the other by 15, find the two numbers.
 ...
 - According to the problem, the other number exceeds the smaller one by 15. So, the larger number will be $x + 15$.
 - The \sum of these two numbers is 95. We can write this as an equation:
 x + (x + 15) = 95
 ...
 - To verify, check if their \sum is 95: $40 + 55 = 95$. Yes, it is!
 - **Answer:** The two numbers are 40 and 55.

- **Q3:** Solve for $t$: $3(t - 3) = 5(2t + 1)$
 - **Trap:** Forgetting to apply the distributive property correctly to *all* terms inside the parentheses. A common error is multiplying only the first term and leaving the second term untouched (e.g., $3t - 3$ instead of $3t - 9$). Pay close attention to signs!
 - **Solution:**
 - First, apply the distributive property on both sides of the equation. Multiply the number outside the parentheses by each term inside.
 - For the left side: $3 \times t$ and $3 \times (-3)$.
 - For the right side: $5 \times 2t$ and $5 \times 1$.
 3t - 9 = 10t + 5
 - Now, we need to gather the terms with $t$ on one side and the constant terms on the other. It's often easier to move the smaller $t$ term to the side with the larger $t$ term to avoid negative coefficients for $t$.
