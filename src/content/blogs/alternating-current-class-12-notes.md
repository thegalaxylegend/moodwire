...
2. [<a id="what-is-alternating-current"></a>What is Alternating Current?](#a-idwhat-is-alternating-currentawhat-is-alternating-current)
3. [<a id="what-are-the-advantages-of-alternating-current-over-direct-current"></a>What are the advantages of Alternating Current over Direct Current?](#a-idwhat-are-the-advantages-of-alternating-current-over-direct-currentawhat-are-the-advantages-of-alternating-current-over-direct-current)
4. [<a id="how-does-an-alternating-current-circuit-work"></a>How does an Alternating Current circuit work?](#a-idhow-does-an-alternating-current-circuit-workahow-does-an-alternating-current-circuit-work)
5. [<a id="what-is-the-difference-between-peak-n-root-mean-square-values-n-alternating-current"></a>What is the difference between Peak and Root Mean Square values and Alternating Current?](#a-idwhat-is-the-difference-between-peak-n-root-mean-square-values-n-alternating-currentawhat-is-the-difference-between-peak-and-root-mean-square-values-and-alternating-current)
6. [<a id="what-is-the-concept-of-phasors-n-alternating-current"></a>What is the concept of Phasors and Alternating Current?](#a-idwhat-is-the-concept-of-phasors-n-alternating-currentawhat-is-the-concept-of-phasors-and-alternating-current)
7. [<a id="what-is-ayushs-note-on-alternating-current"></a>What is Ayush's Note on Alternating Current?](#a-idwhat-is-ayushs-note-on-alternating-currentawhat-is-ayushs-note-on-alternating-current)
8. [<a id="how-do-you-calculate-the-impedance-of-an-alternating-current-circuit"></a>How do you calculate the Impedance of an Alternating Current circuit?](#a-idhow-do-you-calculate-the-impedance-of-an-alternating-current-circuitahow-do-you-calculate-the-impedance-of-an-alternating-current-circuit)
9. [<a id="what-are-the-different-types-of-alternating-current-circuits"></a>What are the different types of Alternating Current circuits?](#a-idwhat-are-the-different-types-of-alternating-current-circuitsawhat-are-the-different-types-of-alternating-current-circuits)
10. [<a id="what-is-the-key-shortcut-or-trick-for-alternating-current"></a>What is the key Shortcut or Trick for Alternating Current?](#a-idwhat-is-the-key-shortcut-or-trick-for-alternating-currentawhat-is-the-key-shortcut-or-trick-for-alternating-current)
11. [<a id="what-are-common-trap-questions-for-alternating-current"></a>What are common Trap Questions for Alternating Current?](#a-idwhat-are-common-trap-questions-for-alternating-currentawhat-are-common-trap-questions-for-alternating-current)
...
- [What are the advantages of Alternating Current over Direct Current?](#what-are-the-advantages-of-alternating-current-over-direct-current)
- [How does an Alternating Current circuit work?](#how-does-an-alternating-current-circuit-work)
- [What is the difference between Peak and Root Mean Square values and Alternating Current?](#what-is-the-difference-between-peak-n-root-mean-square-values-n-alternating-current)
- [What is the concept of Phasors and Alternating Current?](#what-is-the-concept-of-phasors-n-alternating-current)
- [What is Ayush's Note on Alternating Current?](#what-is-ayushs-note-on-alternating-current)
- [How do you calculate the Impedance of an Alternating Current circuit?](#how-do-you-calculate-the-impedance-of-an-alternating-current-circuit)
- [What are the different types of Alternating Current circuits?](#what-are-the-different-types-of-alternating-current-circuits)
- [What is the key Shortcut or Trick for Alternating Current?](#what-is-the-key-shortcut-or-trick-for-alternating-current)
- [What are common Trap Questions for Alternating Current?](#what-are-common-trap-questions-for-alternating-current)
- [MCQs](#mcqs)
...
* **LCR circuits**: Familiarity with the behavior of resistors, inductors, n capacitors and circuits is necessary for analyzing AC circuits.
* **Oscillations**: Knowledge of simple harmonic motion and oscillations will help you understand the periodic nature of AC.
* **Trigonometry**: A good grasp of trigonometric concepts, such as **sine**, **cosine**, n **phasors**, is required for representing and analyzing AC circuits.

As we progress through this topic, you'll discover that AC is not just a simple concept, but rather a complex and fascinating subject that has numerous applications and our daily lives. From the **transmission of electrical power** over long distances to the **operation of electronic devices**, AC plays a vital role and modern technology.

To set the stage for our exploration of AC, let's consider a few key terms:
* **Alternating [current](/blog/magnetic-effects-of-current-class-12-notes) (AC)**: An electric [current](/blog/magnetic-effects-of-current-class-12-notes) that periodically reverses direction, typically used and households and industries.
* **Peak voltage**: The maximum voltage attained y an AC waveform.
...
* **Phasor**: A mathematical representation of an AC waveform using complex numbers, which helps and analyzing and visualizing AC circuits.

Some essential concepts that we'll cover and our journey through AC include:
* **AC waveform**: The graphical representation of an AC signal, which can be **sine**, **square**, or **triangular** n shape.
* **Frequency**: The number of oscillations or cycles per second, measured n **Hertz (Hz)**.
* **Phase difference**: The difference and phase between two or more AC waveforms, which can be represented using **phasors**.
* **Impedance**: The total opposition to the flow of an AC [current](/blog/magnetic-effects-of-current-class-12-notes), which includes **resistance**, **inductive reactance**, n **capacitive reactance**.

As we the world of AC, you'll encounter various types of AC circuits, including:
* **Series LCR circuits**: Circuits consisting of a resistor, inductor, n capacitor connected and series.
* **Parallel LCR circuits**: Circuits consisting of a resistor, inductor, n capacitor connected and parallel.
* **RC circuits**: Circuits consisting of a resistor and capacitor connected and series or parallel.
* **LC circuits**: Circuits consisting of an inductor and capacitor connected and series or parallel.
...
* Analyzing AC waveforms and phasors
* Calculating impedance and phase difference and AC circuits
* Applying Kirchhoff's laws to AC circuits
* Solving problems involving series and parallel LCR circuits
...
| --- | --- | --- |
| Definition | Periodically reverses direction | Flows and one direction |
| Waveform | Sinusoidal | Constant |
...
What are the advantages of Alternating [Current](/blog/magnetic-effects-of-current-class-12-notes) over Direct [Current](/blog/magnetic-effects-of-current-class-12-notes)? is the comparison of two types of electric [current](/blog/magnetic-effects-of-current-class-12-notes). It includes the principles of direct [current](/blog/magnetic-effects-of-current-class-12-notes) (DC), alternating [current](/blog/magnetic-effects-of-current-class-12-notes) (AC), n the transformers used and AC systems. For class 12 exam prep and 2026, the most important aspect is understanding how AC surpasses DC and terms of efficiency, cost, n scalability for widespread electricity distribution.
 ...
 Another significant advantage of AC systems is their ease of conversion. AC can be easily converted to DC using rectifiers, but converting DC to AC requires more complex and expensive inverters. This flexibility and conversion makes AC more versatile for both household and industrial applications.

 In terms of generation, AC is more convenient because AC generators (alternators) are simpler and more efficient than DC generators. This simplicity and efficiency and generation contribute to the widespread use of AC and power plants.

 The use of AC also facilitates the transmission of power over long distances without significant loss of energy. This is crucial for meeting the electricity demands of remote areas. The ability to transmit power efficiently over long distances has made AC the standard for electric power distribution worldwide.
...
| Efficiency and Transmission | High voltage transmission reduces energy loss | High energy loss due to constant voltage |
...
| Capacitor | Lags current y $90^{\circ}$ | Leads voltage y $90^{\circ}$ | $X_C = \frac{1}{2\pi fC}$ | $Z = \sqrt{R^2 + X_C^2}$ |
...
To understand the difference between peak and RMS values, it's essential to consider the concept of power delivery. When an AC circuit has a resistive load, such as a light bulb, the power delivered to the load is determined y the RMS value of the current, not the peak value. This is because the power dissipated y the load is proportional to the square of the current. As a result, the RMS value provides a more accurate representation of the AC's ability to deliver power.

Here's a comparison of peak and RMS values:
The relationship between peak and RMS values can be summarized as follows:
- Peak value: The maximum value of the AC waveform, represented y $V_p$ or $I_p$.
...
Phasors and Alternating Current is a mathematical representation of AC circuits using complex numbers, allowing for the analysis of AC circuits y considering the magnitude and phase of voltages and currents. It includes the real axis representing the resistance, the imaginary axis representing the reactance, n the concept of impedance as the vector $\sum of resistance and reactance. For Class 12 exam prep and 2026$, the most important aspect is understanding how to apply phasors to solve AC circuit problems, particularly those involving $R$, $L$, n $C$ components and series and parallel configurations.
 ...
 The use of phasors and AC circuits can be compared to the use of $j$ (the imaginary unit, where $j^2 = -1$) n mathematics. In an AC circuit, inductors and capacitors cause the current and voltage to be out of phase. Inductors cause the current to lag behind the voltage, while capacitors cause the current to lead the voltage. This can be represented using phasors, with inductive reactance being $+jX_L$ n capacitive reactance being $-jX_C$, where $X_L$ n $X_C$ are the inductive and capacitive reactances, respectively.

 **Key Terms**:
 - **Impedance ($Z$)**: The total opposition to the flow of an AC current, including both resistance ($R$) n reactance ($X$).
 - **Reactance ($X$)**: The opposition to the change and current due to inductors and capacitors.
 - **Phase Angle ($phi$)**: The angle y which the current leads or lags the voltage and an AC circuit.
 ...
 **Key Terms**:
 - **Reactance**: The opposition to the change and current and an AC circuit due to inductors and capacitors.
...
| --- | --- | --- |
| Resistive AC Circuit | No phase shift, voltage and current and phase |  + (\frac{1}{X_L} - \frac{1}{X_C})^2}}$phi = 0^{\circ}$ |
| Inductive AC Circuit | Current lags behind voltage | $phi > 0^{\circ}$ |
| Capacitive AC Circuit | Current leads voltage | $phi < 0^{\circ}$ |
| RLC Circuit | Combination of resistive, inductive, n capacitive effects, can exhibit resonance | $phi$ depends on circuit configuration |
...
- The voltage of Alternating Current can be changed using transformers.
- Alternating Current is more efficient for long-distance transmission due to reduced energy loss.
- The opposition to the flow of Alternating Current includes resistance, reactance, n impedance.
- Alternating Current is used and households for power distribution.
- Single Phase and Three Phase are types of Alternating Current used and households and industries respectively.
...
It is only used and low-voltage applications
...
**2. What is the term for the rate of change of current with respect to time and Alternating Current?**
Frequency
Amplitude
Period
Impedance
...
**Answer:**
B) The rate of change of current with respect to time and Alternating Current is called Amplitude, but more accurately, it is the rate of change of current that defines frequency (Hz).
...
**Answer:** A) Transformers are used to change the voltage of an Alternating Current y using [magnetic](/blog/magnetic-effects-of-current-class-12-notes) induction.
...
**Answer:**
C) Impedance is the opposition to the flow of Alternating Current due to the reactance of inductive and capacitive components, n addition to resistance.
**5. Which of the following types of Alternating Current is used and households?**
Single Phase
Three Phase
Direct Current
Pulse Width Modulation

**Answer:** A) Single Phase Alternating Current is commonly used and households for power distribution.
...
> 🎬 **[Watch video explanations on YouTube →](https://www.youtube.com/results?search_query=Alternating%20Current%20Class%2012%20Physics%20Revision%20%E2%80%94%20JEE%20%26%20NEET%202026%20Grandmaster%20Guide%20JEE%20NEET%20revision)**
...
* **Alternating Current (AC)**: Current that periodically reverses direction, unlike direct current (DC) which flows and one direction.
     * **AC Circuit**: Consists of resistor (R), inductor (L), n capacitor (C) connected and series or parallel.
