...
category: "Physics"
keywords: "Ray Optics quick revision, Ray Optics recap notes, class Class 12 Physics summary, JEE NEET quick notes, Exam Compass"
---
...
2. The angle of deviation through a prism is:
a) $\delta = i + e - A$
b) $\delta = i - e + A$
c) $\delta = i + e + A$
d) $\delta = i - e - A$

Answer: a) $\delta = i + e - A$

3. The focal length of a concave mirror is:
a) $f = \frac{R}{2}$
b) $f = -\frac{R}{2}$
c) $f = R$
d) $f = -R$
