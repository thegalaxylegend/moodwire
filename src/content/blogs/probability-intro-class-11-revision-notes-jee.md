...
| Binomial Distribution | $P(X = k) = inom{n}{k} p^k (1-p)^{n-k}$ | Models the number of successes and and independent trials, each with a probability p of success |
...
**Answer:**
C) There are 5 students with blue eyes and 15 students and total.
