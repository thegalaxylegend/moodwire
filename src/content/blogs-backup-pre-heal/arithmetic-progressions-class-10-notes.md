...
- Many students get confused between the formulas for the sum of an AP: IS_n = $\frac{n}{2} [2a + (n-1)d] and IS_n = \frac{n}{2} (a + l).$
...
**Answer: C) 160. Explanation:** The common difference CD = 5–2 = 3. Using the formula IS_n = $\frac{n}{2} [2a + (n-1)d]$, we get IS_{10} = $\frac{10}{2} [2(2) + (10-1)3] = 5 [4 + 27] = $5 \times 3$1 = 155.$
...
**Answer: B) 17. Explanation:** The common difference CD = 13–7 = 6. The last term SL = 91. Using the formula in = $\frac{l - a}{d} + 1$, we get in = $\frac{91–7}{6} + 1 = \frac{84}{6} + 1 = 14 + 1 = 15.$
