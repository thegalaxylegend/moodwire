...
async function main() {
    await expandFile('databases-dbms-class-12-notes.md', 'Databases and DBMS');
    await expandFile('trigonometric-functions-class-11-revision-notes-jee-neet.md', 'Trigonometric Functions');
}
